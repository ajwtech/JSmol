...
Clazz.load (null, "javax.vecmath.Tuple4f", ["java.lang.Float", "$.InternalError", "javax.vecmath.VecMathUtil"], function () {
...
}, javax.vecmath, "Tuple4f", null, [java.io.Serializable, Cloneable]);
...
this.z = s * t1.z + t2.z;
this.w = s * t1.w + t2.w;
}, "~N,javax.vecmath.Tuple4f,javax.vecmath.Tuple4f");
Clazz.defineMethod (c$, "scaleAdd", 
function (s, t1) {
...
}, "javax.vecmath.Tuple4f,javax.vecmath.Tuple4f,~N");
Clazz.defineMethod (c$, "interpolate", 
function (t1, alpha) {
...
function () {
try {
return Clazz.superCall (this, javax.vecmath.Tuple4f, "clone", []);
} catch (e) {
