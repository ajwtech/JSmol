...
Clazz.load (null, "javax.vecmath.Tuple2i", ["java.lang.InternalError"], function () {
c$ = Clazz.decorateAsClass (function () {
this.x = 0;
this.y = 0;
Clazz.instantialize (this, arguments);
}, javax.vecmath, "Tuple2i", null, [java.io.Serializable, Cloneable]);
...
this.x = t1.x + t2.x;
this.y = t1.y + t2.y;
}, "javax.vecmath.Tuple2i,javax.vecmath.Tuple2i");
Clazz.defineMethod (c$, "add", 
function (t1) {
this.x += t1.x;
this.y += t1.y;
...
this.x = s * t1.x + t2.x;
this.y = s * t1.y + t2.y;
}, "~N,javax.vecmath.Tuple2i,javax.vecmath.Tuple2i");
Clazz.defineMethod (c$, "scaleAdd", 
function (s, t1) {
...
function () {
try {
return Clazz.superCall (this, javax.vecmath.Tuple2i, "clone", []);
} catch (e) {
