...
Clazz.load (null, "javax.vecmath.Tuple3f", ["java.lang.Float"], function () {
c$ = Clazz.decorateAsClass (function () {
this.x = 0;
this.y = 0;
this.z = 0;
Clazz.instantialize (this, arguments);
}, javax.vecmath, "Tuple3f", null, java.io.Serializable);
...
this.y = s * t1.y + t2.y;
this.z = s * t1.z + t2.z;
}, "~N,javax.vecmath.Tuple3f,javax.vecmath.Tuple3f");
...
function () {
var bits = 1;
bits = 31 * bits + javax.vecmath.Tuple3f.floatToIntBits0 (this.x);
bits = 31 * bits + javax.vecmath.Tuple3f.floatToIntBits0 (this.y);
bits = 31 * bits + javax.vecmath.Tuple3f.floatToIntBits0 (this.z);
return (bits ^ (bits >> 32));
});
...
function (t1) {
if (!(Clazz.instanceOf (t1, javax.vecmath.Tuple3f))) return false;
var t2 = t1;
