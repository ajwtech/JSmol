...
Clazz.load (null, "org.jmol.util.XmlUtil", ["java.lang.Float", "java.util.ArrayList", "javax.util.StringXBuilder", "org.jmol.script.Token", "org.jmol.util.Escape", "$.TextFormat"], function () {
...
}, "javax.util.StringXBuilder,~S,~A,~O,~B,~B");
...
}, "javax.util.StringXBuilder,~S,~A,~O");
...
}, "javax.util.StringXBuilder,~S,java.util.List");
...
var v = value;
sb =  new javax.util.StringXBuilder ().append ("\n");
if (atts == null) atts =  new java.util.ArrayList ();
atts.add (["count", Integer.$valueOf (v.size ())]);
for (var i = 0; i < v.size (); i++) sb.appendO (org.jmol.util.XmlUtil.escape (null, null, v.get (i), true, indent + "  "));
...
n++;
var name2 = e.next ();
sb.appendO (org.jmol.util.XmlUtil.escape (name2, null, ht.get (name2), true, indent + "  "));
}
if (atts == null) atts =  new java.util.ArrayList ();
...
for (var i = 0; i < f.length; i++) sb.appendO (org.jmol.util.XmlUtil.escape (null, null,  new Float (f[i]), true, indent + "  "));
...
for (var i = 0; i < iv.length; i++) sb.appendO (org.jmol.util.XmlUtil.escape (null, null,  new Integer (iv[i]), true, indent + "  "));
...
for (var i = 0; i < o.length; i++) sb.appendO (org.jmol.util.XmlUtil.escape (null, null, o[i], true, indent + "  "));
