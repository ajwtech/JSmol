...
c$.isCompoundDocument = Clazz.defineMethod (c$, "isCompoundDocument", 
function (is) {
var abMagic =  Clazz.newArray (8, 0);
is.mark (9);
...
function () {
return this.getAllData (null, null);
});
Clazz.defineMethod (c$, "getAllData", 
...
this.nShortSectorsPerStandardSector = Math.floor (this.sectorSize / this.shortSectorSize);
this.nIntPerSector = Math.floor (this.sectorSize / 4);
this.nDirEntriesperSector = Math.floor (this.sectorSize / 128);
...
var nSID = 0;
var thisSID;
this.SAT =  Clazz.newArray (this.header.nSATsectors * this.nIntPerSector + 109, 0);
try {
for (var i = 0; i < 109; i++) {
...
var MSAT =  Clazz.newArray (this.nIntPerSector, 0);
...
this.SSAT =  Clazz.newArray (nMax, 0);
try {
...
var ptShort = 0;
var byteBuf =  Clazz.newArray (this.shortSectorSize, 0);
var gzipData =  new org.jmol.util.ZipData (nBytes);
try {
...
Clazz.prepareFields (c$, function () {
this.magicNumbers =  Clazz.newArray (8, 0);
this.uniqueID =  Clazz.newArray (16, 0);
this.unused =  Clazz.newArray (10, 0);
this.unused2 =  Clazz.newArray (4, 0);
this.MSAT0 =  Clazz.newArray (109, 0);
});
...
Clazz.prepareFields (c$, function () {
this.unicodeName =  Clazz.newArray (64, 0);
this.uniqueID =  Clazz.newArray (16, 0);
this.userflags =  Clazz.newArray (4, 0);
this.unused =  Clazz.newArray (4, 0);
});
Clazz.defineMethod (c$, "readData", 
function () {
try {
...
this.entryName = "";
for (var a = 0; a < this.nBytesUnicodeName - 2; a += 2) this.entryName += (String.fromCharCode (this.unicodeName[a])).charCodeAt (0);
