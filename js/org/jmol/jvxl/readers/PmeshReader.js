...
Clazz.load (["org.jmol.jvxl.readers.PolygonFileReader"], "org.jmol.jvxl.readers.PmeshReader", ["javax.vecmath.Point3f", "org.jmol.jvxl.data.JvxlCoder", "org.jmol.util.BinaryDocument", "$.Logger"], function () {
...
try {
var ignored =  Clazz.newArray (64, 0);
...
this.vertexMap =  Clazz.newArray (this.nVertices, 0);
...
var vertices =  Clazz.newArray (5, 0);
...
if (this.onePerLine) this.iToken = 2147483647;
if (!isOK) continue ;if (vertexCount < 3) for (var i = vertexCount; i < 3; ++i) vertices[i] = vertices[i - 1];
