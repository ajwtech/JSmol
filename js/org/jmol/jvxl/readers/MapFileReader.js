...
var unitCell =  new org.jmol.util.SimpleUnitCell ([this.a / this.na, this.b / this.nb, this.c / this.nc, this.alpha, this.beta, this.gamma]);
this.vectors[0] =  new javax.vecmath.Point3f (1, 0, 0);
this.vectors[1] =  new javax.vecmath.Point3f (0, 1, 0);
this.vectors[2] =  new javax.vecmath.Point3f (0, 0, 1);
...
this.origin.scaleAdd (this.nxyzStart[xIndex] + this.adjustment.x, this.vectors[0], this.origin);
this.origin.scaleAdd (this.nxyzStart[yIndex] + this.adjustment.y, this.vectors[1], this.origin);
this.origin.scaleAdd (this.nxyzStart[zIndex] + this.adjustment.z, this.vectors[2], this.origin);
