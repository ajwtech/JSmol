...
Clazz.load (["javax.vecmath.Matrix4f", "$.Point3f"], "org.jmol.symmetry.SymmetryOperation", ["java.lang.Float", "$.StringBuffer", "java.util.ArrayList", "javax.vecmath.Point4f", "$.Vector3f", "org.jmol.util.Escape", "$.Logger", "$.Measure", "$.Parser", "$.Quaternion", "$.TriangleData"], function () {
