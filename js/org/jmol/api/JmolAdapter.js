...
if (!Clazz.isClassDefined ("org.jmol.api.JmolAdapter.AtomIterator")) {
org.jmol.api.JmolAdapter.$JmolAdapter$AtomIterator$ ();
}
if (!Clazz.isClassDefined ("org.jmol.api.JmolAdapter.BondIterator")) {
org.jmol.api.JmolAdapter.$JmolAdapter$BondIterator$ ();
}
if (!Clazz.isClassDefined ("org.jmol.api.JmolAdapter.StructureIterator")) {
org.jmol.api.JmolAdapter.$JmolAdapter$StructureIterator$ ();
}
...
c$.$JmolAdapter$AtomIterator$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
c$.$JmolAdapter$BondIterator$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
}, org.jmol.api.JmolAdapter, "BondIterator");
c$ = Clazz.p0p ();
};
c$.$JmolAdapter$StructureIterator$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
}, org.jmol.api.JmolAdapter, "StructureIterator");
c$ = Clazz.p0p ();
};
