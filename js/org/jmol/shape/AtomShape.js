...
if (this.mads == null && i0 >= 0) this.mads =  Clazz.newArray (this.atomCount, 0);
...
}this.colixes[i] = org.jmol.util.Colix.getColixTranslucent (this.colixes[i], isTranslucent, this.translucentLevel);
