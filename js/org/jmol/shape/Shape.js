...
Clazz.load (null, "org.jmol.shape.Shape", ["org.jmol.constant.EnumPalette", "org.jmol.g3d.Graphics3D", "org.jmol.util.Logger", "org.jmol.viewer.JmolConstants", "$.StateManager"], function () {
...
this.initShape ();
}, "org.jmol.viewer.Viewer,org.jmol.g3d.Graphics3D,org.jmol.modelset.ModelSet,~N");
...
function (colix) {
return (org.jmol.g3d.Graphics3D.isColixColorInherited (colix) ? "none" : org.jmol.g3d.Graphics3D.getHexCode (colix));
}, "~N");
c$.getTranslucentLabel = Clazz.defineMethod (c$, "getTranslucentLabel", 
function (colix) {
return (org.jmol.g3d.Graphics3D.isColixTranslucent (colix) ? "translucent " + org.jmol.g3d.Graphics3D.getColixTranslucencyFractional (colix) : "opaque");
}, "~N");
c$.getColix = Clazz.defineMethod (c$, "getColix", 
function (colixes, i, atom) {
return org.jmol.g3d.Graphics3D.getColixInherited ((colixes == null || i >= colixes.length ? 0 : colixes[i]), atom.getColix ());
