...
Clazz.load (["org.jmol.shape.Shape"], "org.jmol.shape.MeshCollection", ["java.lang.StringBuffer", "java.util.Hashtable", "javax.vecmath.Point3f", "org.jmol.g3d.Graphics3D", "org.jmol.script.Token", "org.jmol.shape.Mesh", "org.jmol.util.ArrayUtil", "$.Escape", "$.Logger", "$.TextFormat", "org.jmol.viewer.StateManager"], function () {
...
this.currentMesh = this.meshes[index] = (m == null ?  new org.jmol.shape.Mesh (thisID, this.g3d, this.colix, index) : m);
