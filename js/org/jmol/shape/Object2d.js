...
Clazz.load (null, "org.jmol.shape.Object2d", ["java.lang.Float", "org.jmol.g3d.Graphics3D"], function () {
...
Clazz.makeConstructor (c$, 
function (viewer, g3d, target, colix, valign, align, scalePixelsPerMicron) {
this.viewer = viewer;
this.g3d = g3d;
this.isLabelOrHover = false;
this.target = target;
...
this.scalePixelsPerMicron = scalePixelsPerMicron;
}, "org.jmol.viewer.Viewer,org.jmol.g3d.Graphics3D,~S,~N,~N,~N,~N");
...
Clazz.defineMethod (c$, "setColix", 
function (value) {
this.colix = org.jmol.g3d.Graphics3D.getColix (value);
}, "~O");
Clazz.defineMethod (c$, "setTranslucent", 
function (level, isBackground) {
if (isBackground) {
if (this.bgcolix != 0) this.bgcolix = org.jmol.g3d.Graphics3D.getColixTranslucent (this.bgcolix, !Float.isNaN (level), level);
} else {
this.colix = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colix, !Float.isNaN (level), level);
}}, "~N,~B");
...
Clazz.defineMethod (c$, "setBgColix", 
function (value) {
this.bgcolix = (value == null ? 0 : org.jmol.g3d.Graphics3D.getColix (value));
}, "~O");
...
Clazz.defineMethod (c$, "drawPointer", 
function (g3d) {
if ((this.pointer & 1) != 0) {
if (!g3d.setColix ((this.pointer & 2) != 0 && this.bgcolix != 0 ? this.bgcolix : this.colix)) return ;
if (this.boxX > this.movableX) g3d.drawLine (this.movableX, this.movableY, this.zSlab, Math.round (this.boxX), Math.round ((this.boxY + this.boxHeight / 2)), this.zSlab);
 else if (this.boxX + this.boxWidth < this.movableX) g3d.drawLine (this.movableX, this.movableY, this.zSlab, Math.round ((this.boxX + this.boxWidth)), Math.round ((this.boxY + this.boxHeight / 2)), this.zSlab);
...
function (g3d, scalePixelsPerMicron) {
...
}, "org.jmol.api.JmolRendererInterface,~N");
