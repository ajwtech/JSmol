...
Clazz.load (["java.util.BitSet", "org.jmol.modelset.Atom", "org.jmol.modelsetbio.NucleicMonomer", "org.jmol.viewer.JmolConstants"], "org.jmol.shapebio.BioShape", ["java.lang.Float", "org.jmol.constant.EnumStructure", "org.jmol.g3d.Graphics3D", "org.jmol.shape.Shape", "org.jmol.util.Logger"], function () {
...
}var isVisible = ((this.mads[i] = this.setMad (i, mad)) > 0);
...
this.colixes[i] = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colixes[i], isTranslucent, translucentLevel);
this.bsColixSet.set (i, this.colixes[i] != 0);
}
