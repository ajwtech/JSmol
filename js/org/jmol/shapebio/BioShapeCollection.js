...
Clazz.load (["org.jmol.shape.Shape"], "org.jmol.shapebio.BioShapeCollection", ["java.util.Hashtable", "org.jmol.constant.EnumPalette", "org.jmol.g3d.Graphics3D", "org.jmol.shapebio.BioShape", "org.jmol.util.ArrayUtil", "$.BitSetUtil"], function () {
...
var colix = org.jmol.g3d.Graphics3D.getColix (value);
for (var i = this.bioShapes.length; --i >= 0; ) {
var bioShape = this.bioShapes[i];
...
return "\n" + org.jmol.shape.Shape.getShapeCommands (temp, temp2, this.shapeID == 9 ? "Backbone" : "select");
});
