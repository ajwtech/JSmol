...
Clazz.load (["java.lang.Exception"], "org.jmol.script.ScriptEvaluator", ["java.lang.Boolean", "$.Float", "$.NullPointerException", "$.Short", "$.StringBuffer", "$.Thread", "java.util.ArrayList", "$.BitSet", "$.Hashtable", "javax.vecmath.Matrix3f", "$.Matrix4f", "$.Point3f", "$.Point4f", "$.Vector3f", "org.jmol.atomdata.RadiusData", "org.jmol.constant.EnumAnimationMode", "$.EnumAxesMode", "$.EnumPalette", "$.EnumStereoMode", "$.EnumStructure", "$.EnumVdw", "org.jmol.g3d.Graphics3D", "org.jmol.i18n.GT", "org.jmol.modelset.Atom", "$.AtomCollection", "$.Bond", "$.Group", "$.LabelToken", "$.MeasurementData", "$.ModelCollection", "$.TickInfo", "org.jmol.script.ScriptCompiler", "$.ScriptContext", "$.ScriptMathProcessor", "$.ScriptVariable", "$.Token", "org.jmol.shape.Object2d", "org.jmol.util.ArrayUtil", "$.BitSetUtil", "$.BoxInfo", "$.ColorEncoder", "$.ColorUtil", "$.Elements", "$.Escape", "$.JmolEdge", "$.Logger", "$.Measure", "$.MeshSurface", "$.Parser", "$.Point3fi", "$.Quaternion", "$.TextFormat", "org.jmol.viewer.FileManager", "$.JmolConstants", "$.PropertyManager", "$.StateManager", "$.Viewer"], function () {
...
if (!Clazz.isClassDefined ("org.jmol.script.ScriptEvaluator.ScriptException")) {
org.jmol.script.ScriptEvaluator.$ScriptEvaluator$ScriptException$ ();
}
...
for (var i = 0; i < xyz.length; i += 2) params.add (org.jmol.script.ScriptVariable.getVariable (Float.$valueOf (0)).setName (xyz.substring (i, i + 1)));
...
if (script !== "") this.runScript (script, null);
} catch (er) {
if (Clazz.instanceOf (er, Error)) {
...
if (Clazz.instanceOf (e, org.jmol.script.ScriptEvaluator.ScriptException)) {
...
this.contextVariables = this.viewer.getContextVariables ();
return this.atomExpression (expr, 0, 0, true, false, true, false);
}} catch (ex) {
if (Clazz.instanceOf (ex, Exception)) {
...
if (Clazz.instanceOf (atomExpression, java.util.BitSet)) return atomExpression;
...
return (result.size () > 0 ? result.get (0) : org.jmol.script.ScriptVariable.getVariable (""));
}, $fz.isPrivate = true, $fz), "~N");
...
if (!rpn.addOp (token, (this.tokAt (i + 1) == 269484048))) this.error (22);
...
break out;
case 3:
rpn.addXNum (org.jmol.script.ScriptVariable.getVariable (this.theToken.value));
break;
case 1048614:
case 2:
rpn.addXNum (org.jmol.script.ScriptVariable.intVariable (this.theToken.intValue));
break;
case 135266319:
if (this.tokAt (this.iToken + 1) == 269484048) {
if (!rpn.addOp (this.theToken, true)) this.error (22);
break;
}rpn.addX ( new org.jmol.script.ScriptVariable (this.theToken));
break;
case 1087375362:
case 1087375361:
case 1048580:
...
rpn.addX ( new org.jmol.script.ScriptVariable (8, ptc));
} catch (e) {
if (Clazz.instanceOf (e, Exception)) {
rpn.addX ("");
} else {
...
if (!rpn.addOp (token, allowMathFunc)) this.error (22);
i = this.iToken;
...
if (!rpn.addOp ( new org.jmol.script.ScriptVariable (135368713, this.theToken.value))) this.error (22);
if (!haveParens) {
rpn.addOp (org.jmol.script.Token.tokenLeftParen);
rpn.addOp (org.jmol.script.Token.tokenRightParen);
}} else {
...
if (v != null) {
if (Clazz.instanceOf (v, java.util.BitSet)) rpn.addX (v);
 else rpn.addX (v);
}}
...
if (returnBoolean) return Boolean.$valueOf (org.jmol.script.ScriptVariable.bValue (result));
if (returnString) {
...
resx.add ( new org.jmol.script.ScriptVariable (10, v));
}return resx;
}, "~O");
...
if (asIdentity) str = modelSet.atoms[j].getInfo ();
 else str = org.jmol.modelset.LabelToken.formatLabel (this.viewer, modelSet.atoms[j], tokens, '\0', indices);
} else {
var bond = modelSet.getBondAt (j);
if (asIdentity) str = bond.getIdentity ();
 else str = org.jmol.modelset.LabelToken.formatLabel (this.viewer, bond, tokens, htValues, indices);
}str = org.jmol.util.TextFormat.formatString (str, "#", (n + 1));
sout[n++] = str;
if (haveIndex) break;
}
return nmax == 1 && !isExplicitlyAll ? sout[0] : sout;
}, "java.util.BitSet,~S,~O,~B,~N,~B");
...
return  new org.jmol.script.ScriptVariable (269484241, tok, this.parameterAsString (i).toLowerCase ());
...
return data;
}, $fz.isPrivate = true, $fz), "java.util.BitSet,~N,~N,~N");
...
var fout = (minmaxtype == 256 ?  Clazz.newArray (atomCount, 0) : null);
...
var zero = (minmaxtype == 256 ?  new javax.vecmath.Point3f () : null);
var pt = (isPt || !isAtoms ?  new javax.vecmath.Point3f () : null);
...
params = (opValue)[1];
bsAtom =  new java.util.BitSet (atomCount);
tokenAtom =  new org.jmol.script.ScriptVariable (10, bsAtom);
break;
case 1112539148:
case 1112539149:
...
break;
case 1276118018:
if (ptRef == null && planeRef == null) return  new javax.vecmath.Point3f ();
break;
case 1766856708:
ptT =  new javax.vecmath.Point3f ();
break;
case 1716520973:
...
case 135368713:
bsAtom.set (i);
fv = org.jmol.script.ScriptVariable.fValue (this.runFunction (null, userFunction, params, tokenAtom, true, true));
bsAtom.clear (i);
break;
case 1716520973:
...
case 1095766022:
case 1095761925:
this.error (45, org.jmol.script.Token.nameOf (tok));
break;
default:
...
switch (minmaxtype) {
case 256:
fout[i] = org.jmol.util.Parser.parseFloat (s);
break;
default:
...
if (t == null) this.error (45, org.jmol.script.Token.nameOf (tok));
switch (minmaxtype) {
case 256:
...
break;
default:
this.error (46, org.jmol.script.Token.nameOf (tok));
}
}
...
break;
case 2:
fout[i] = org.jmol.util.Parser.parseFloat (v);
break;
case 3:
...
for (var i = len; --i >= 0; ) {
var v = vout.get (i);
if (Clazz.instanceOf (v, javax.vecmath.Point3f)) sout[i] = org.jmol.util.Escape.escape (v);
...
break;
case 128:
return Integer.$valueOf (Math.round (sum));
default:
if (sum / n == Math.round ((sum / n))) return Integer.$valueOf (Math.round ((sum / n)));
...
}, "java.util.BitSet,~N,javax.vecmath.Point3f,javax.vecmath.Point4f,~O,~O,~B,~N,~B");
...
switch (tokenValue.tok) {
case 7:
var values =  Clazz.newArray (nValues, 0);
...
if (values[i] == 0) values[i] = org.jmol.script.ScriptVariable.iValue (svi);
}if (values[i] == 0) this.error (50, "ARRAY", svi.asString ());
}
value = values;
prop = "colorValues";
break;
...
this.setShapeProperty (0, prop, value, bs);
return ;
case 1826248715:
case 1288701960:
...
nValues = list.length;
if (!isStrProperty) {
fvalues =  Clazz.newArray (nValues, 0);
for (var i = nValues; --i >= 0; ) fvalues[i] = (tok == 1087375365 ? org.jmol.util.Elements.elementNumberFromSymbol (list[i], false) : org.jmol.util.Parser.parseFloat (list[i]));
...
}, $fz.isPrivate = true, $fz), "java.util.BitSet,~N,~N,~N,org.jmol.script.Token");
...
Clazz.defineMethod (c$, "runScript", 
function (script) {
if (!this.viewer.isPreviewOnly ()) this.runScript (script, this.outputBuffer);
}, "~S");
...
data[0] = filename;
if (!this.viewer.getFileAsString (data, 2147483647, false)) {
this.setErrorMessage ("io error reading " + data[0] + ": " + data[1]);
return false;
}this.scriptFileName = filename;
data[1] = org.jmol.script.ScriptCompiler.getEmbeddedScript (data[1]);
...
v =  new org.jmol.script.ScriptVariable (4, val);
...
if (Clazz.instanceOf (v, String) && key != null) v = this.viewer.setUserVariable (key,  new org.jmol.script.ScriptVariable (4, v));
return v;
}, $fz.isPrivate = true, $fz), "~S,~S");
...
var f = func;
return org.jmol.script.ScriptVariable.fValue (this.runFunction (f, f.name, p, null, true, false));
} catch (e) {
if (Clazz.instanceOf (e, Exception)) {
return NaN;
} else {
...
if (isTry) {
this.contextVariables.put ("_breakval", org.jmol.script.ScriptVariable.intVariable (2147483647));
this.contextVariables.put ("_errorval", org.jmol.script.ScriptVariable.getVariable (""));
...
if (err.length > 0) {
this.contextVariables.put ("_errorval", org.jmol.script.ScriptVariable.getVariable (err));
this.viewer.resetError ();
}this.contextVariables.put ("_tryret", this.contextVariables.get ("_retval"));
this.contextVariables.put ("_retval",  new org.jmol.script.ScriptVariable (0, this.contextVariables));
}}} else {
this.runFunction ($function, params, tokenAtom);
...
}if (Clazz.instanceOf (value, java.util.BitSet)) return value;
...
if ((setName.charAt (len - 1)).charCodeAt (0) != ('s').charCodeAt (0)) return null;
...
if (!entry.getKey ().startsWith ("!")) this.viewer.setUserVariable ("@" + entry.getKey (), org.jmol.script.ScriptVariable.getVariable (value));
}}
}, "java.util.BitSet");
...
var j = 1;
for (i = 1; i < this.statementLength; i++) {
if (this.statement[i] == null) continue ;switch (tok = this.getToken (i).tok) {
default:
...
fixed[j] =  new org.jmol.script.ScriptVariable (10, bs == null ? org.jmol.script.ScriptEvaluator.getAtomBitSet (this, org.jmol.script.ScriptVariable.sValue (fixed[j])) : bs);
...
fixed[j] =  new org.jmol.script.Token (2, (v).intValue (), v);
} else if (Clazz.instanceOf (v, Float)) {
fixed[j] =  new org.jmol.script.Token (3, org.jmol.script.ScriptEvaluator.getFloatEncodedInt ("" + v), v);
...
fixed[j] =  new org.jmol.script.Token (10, org.jmol.script.ScriptEvaluator.getAtomBitSet (this, s));
} else {
if (!isExpression) {
...
fixed[j] =  new org.jmol.script.Token (tok, v);
}}} else if (Clazz.instanceOf (v, java.util.BitSet)) {
fixed[j] =  new org.jmol.script.ScriptVariable (10, v);
} else if (Clazz.instanceOf (v, javax.vecmath.Point3f)) {
fixed[j] =  new org.jmol.script.ScriptVariable (8, v);
} else if (Clazz.instanceOf (v, javax.vecmath.Point4f)) {
fixed[j] =  new org.jmol.script.ScriptVariable (9, v);
} else if (Clazz.instanceOf (v, javax.vecmath.Matrix3f)) {
fixed[j] =  new org.jmol.script.ScriptVariable (11, v);
} else if (Clazz.instanceOf (v, javax.vecmath.Matrix4f)) {
fixed[j] =  new org.jmol.script.ScriptVariable (12, v);
} else if (Clazz.instanceOf (v, java.util.Map)) {
fixed[j] =  new org.jmol.script.ScriptVariable (6, v);
...
fixed[j] = (bs == null ? org.jmol.script.ScriptVariable.getVariable (v) :  new org.jmol.script.Token (10, bs));
} else {
var center = this.getObjectCenter ($var, -2147483648, -2147483648);
if (center == null) this.error (22);
fixed[j] =  new org.jmol.script.Token (8, center);
...
}, $fz.isPrivate = true, $fz), "org.jmol.script.ContextToken");
...
}throw Clazz.innerTypeInstance (org.jmol.script.ScriptEvaluator.ScriptException, this, null, message, strUntranslated);
}, "~S,~S");
...
var setEquals = (statement.length > 1 && tok == 1085443 && statement[0].value.equals ("") && (statement[0].intValue == ('=').charCodeAt (0) || statement[0].intValue == ('#').charCodeAt (0)) && statement[1].tok != 1048577);
...
if (i != 0) sb.append (' ');
if (i == 2 && setEquals) {
if ((setEquals = (token.tok != 269484436)) || statement[0].intValue == ('#').charCodeAt (0)) {
sb.append (setEquals ? "= " : "== ");
if (!setEquals) continue ;}}if (iTok == i && token.tok != 1048578) sb.append (">> ");
switch (token.tok) {
case 1048577:
...
break;
case 1095761925:
if (Clazz.instanceOf (token.value, javax.vecmath.Point3f)) {
var pt = token.value;
sb.append ("cell=").append (org.jmol.util.Escape.escape (pt));
continue ;}break;
case 4:
...
return this.shapeManager.getShapeProperty (shapeType, propertyName, -2147483648);
}, $fz.isPrivate = true, $fz), "~N,~S");
Clazz.defineMethod (c$, "getShapeProperty", 
($fz = function (shapeType, propertyName, data) {
return this.shapeManager.getShapeProperty (shapeType, propertyName, data);
}, $fz.isPrivate = true, $fz), "~N,~S,~A");
Clazz.defineMethod (c$, "getShapeProperty", 
($fz = function (shapeType, propertyName, index) {
return this.shapeManager.getShapeProperty (shapeType, propertyName, index);
...
if (this.isSyntaxCheck) return ;
this.shapeManager.setShapeProperty (shapeType, propertyName, propertyValue, null);
}, $fz.isPrivate = true, $fz), "~N,~S,~O");
Clazz.defineMethod (c$, "setShapeProperty", 
($fz = function (iShape, propertyName, propertyValue, bs) {
if (this.isSyntaxCheck) return ;
this.shapeManager.setShapeProperty (iShape, propertyName, propertyValue, bs);
}, $fz.isPrivate = true, $fz), "~N,~S,~O,java.util.BitSet");
Clazz.defineMethod (c$, "setShapeSize", 
($fz = function (shapeType, size, bs) {
if (this.isSyntaxCheck) return ;
this.shapeManager.setShapeSize (shapeType, size, null, bs);
}, $fz.isPrivate = true, $fz), "~N,~N,java.util.BitSet");
Clazz.defineMethod (c$, "setShapeSize", 
($fz = function (shapeType, rd) {
if (this.isSyntaxCheck) return ;
this.shapeManager.setShapeSize (shapeType, 0, rd, null);
...
($fz = function (index) {
if (!this.checkToken (index)) this.error (2, index);
...
case 1048578:
nExpress--;
if (nExpress > 0) continue ;break expression_loop;
case 1048586:
...
case 1048590:
if (pc > 0 && code[pc - 1].tok == 1048586) rpn.addX ( new java.util.BitSet ());
break;
case 269484096:
isInMath = true;
...
break;
case 1060866:
rpn.addX (org.jmol.script.ScriptEvaluator.getAtomBitSet (this, value));
break;
case 135267841:
rpn.addX ( new org.jmol.script.ScriptVariable (instruction));
rpn.addX ( new org.jmol.script.ScriptVariable (9, this.hklParameter (pc + 2)));
pc = this.iToken;
break;
case 135266319:
rpn.addX ( new org.jmol.script.ScriptVariable (instruction));
rpn.addX ( new org.jmol.script.ScriptVariable (9, this.planeParameter (pc + 2)));
pc = this.iToken;
break;
case 1048582:
rpn.addX ( new org.jmol.script.ScriptVariable (instruction));
...
break;
case 1048579:
rpn.addX (this.viewer.getModelUndeletedAtomsBitSet (-1));
break;
case 1048587:
rpn.addX ( new java.util.BitSet ());
break;
case 1048589:
case 1048588:
rpn.addX ( new org.jmol.script.ScriptVariable (instruction));
break;
case 1114638350:
rpn.addX (org.jmol.util.BitSetUtil.copy (this.viewer.getSelectionSet (false)));
break;
case 3158024:
var bsSubset = this.viewer.getSelectionSubset ();
rpn.addX (bsSubset == null ? this.viewer.getModelUndeletedAtomsBitSet (-1) : org.jmol.util.BitSetUtil.copy (bsSubset));
break;
case 3145770:
rpn.addX (org.jmol.util.BitSetUtil.copy (this.viewer.getHiddenSet ()));
break;
case 1060869:
rpn.addX (org.jmol.util.BitSetUtil.copy (this.viewer.getMotionFixedAtoms ()));
break;
case 3145768:
rpn.addX (org.jmol.util.BitSetUtil.copyInvert (this.viewer.getHiddenSet (), atomCount));
break;
case 3145776:
rpn.addX (this.viewer.getBaseModelBitSet ());
break;
case 3145774:
...
if (atomID > 0) rpn.addX (this.compareInt (1095761922, 269484436, atomID));
 else rpn.addX (this.getAtomBits (instruction.tok, value));
} else {
rpn.addX (this.lookupIdentifierValue ("_" + value));
}break;
case 3145764:
case 3145732:
case 1613758470:
...
case 1089470478:
case 1614417948:
rpn.addX (this.getAtomBits (instruction.tok, value));
break;
case 1048610:
case 1048611:
...
rpn.addX (this.getAtomBits (1048610, Integer.$valueOf (iModel)));
break;
...
break;
case 1048614:
if (isInMath) rpn.addXNum (org.jmol.script.ScriptVariable.intVariable (instruction.intValue));
 else rpn.addX (this.getAtomBits (1048614,  new Integer (org.jmol.script.ScriptEvaluator.getSeqCode (instruction))));
break;
case 1048615:
if (isInMath) {
rpn.addXNum (org.jmol.script.ScriptVariable.intVariable (instruction.intValue));
rpn.addX (org.jmol.script.Token.tokenMinus);
rpn.addXNum (org.jmol.script.ScriptVariable.intVariable (code[++pc].intValue));
break;
}var chainID = (pc + 3 < code.length && code[pc + 2].tok == 269484160 && code[pc + 3].tok == 1048609 ? code[pc + 3].intValue : '\t');
rpn.addX (this.getAtomBits (1048615, [org.jmol.script.ScriptEvaluator.getSeqCode (instruction), org.jmol.script.ScriptEvaluator.getSeqCode (code[++pc]), chainID]));
if (chainID != ('\t').charCodeAt (0)) pc += 2;
break;
case 1095761925:
var pt = value;
rpn.addX (this.getAtomBits (1095761925, [Math.round ((pt.x * 1000)), Math.round ((pt.y * 1000)), Math.round ((pt.z * 1000))]));
break;
case 3145758:
rpn.addX (this.viewer.getModelUndeletedAtomsBitSet (this.viewer.getCurrentModelIndex ()));
break;
case 1613758476:
case 3145730:
case 1115297793:
...
case 3145754:
case 3145756:
rpn.addX (this.lookupIdentifierValue (value));
break;
case 269484435:
case 269484434:
case 269484433:
...
if (Clazz.instanceOf (val, javax.vecmath.Point3f)) {
...
if (Clazz.instanceOf (val, javax.vecmath.Point3f)) comparisonValue = org.jmol.util.ColorUtil.colorPtToInt (val);
...
comparisonValue = Math.round (comparisonFloat);
}}} else if (!isStringProperty) {
this.iToken++;
this.error (22);
...
rpn.addX (isIntProperty ? this.compareInt (tokWhat, tokOperator, comparisonValue) : isStringProperty ? this.compareString (tokWhat, tokOperator, val) : this.compareFloat (tokWhat, data, tokOperator, comparisonFloat));
break;
case 3:
case 2:
rpn.addXNum ( new org.jmol.script.ScriptVariable (instruction));
break;
case 10:
...
this.expressionResult = (this.isSyntaxCheck ?  new java.util.BitSet () : org.jmol.script.ScriptEvaluator.getAtomBitSet (this, this.expressionResult));
}if (!mustBeBitSet && !(Clazz.instanceOf (this.expressionResult, java.util.BitSet))) return null;
var bs = (Clazz.instanceOf (this.expressionResult, java.util.BitSet) ? this.expressionResult :  new java.util.BitSet ());
...
if (bs.length () > this.viewer.getAtomCount ()) bs.clear ();
...
break;
case 1716520973:
if (data == null || data.length <= i) continue ;propertyFloat = data[i];
}
...
if (this.compareString (tokOperator, propertyString, comparisonString)) bs.set (i);
}
return bs;
...
switch (tokOperator) {
case 269484435:
return org.jmol.util.BitSetUtil.newBitSet (0, comparisonValue);
case 269484434:
return org.jmol.util.BitSetUtil.newBitSet (0, comparisonValue + 1);
case 269484433:
return org.jmol.util.BitSetUtil.newBitSet (comparisonValue, atomCount);
case 269484432:
return org.jmol.util.BitSetUtil.newBitSet (comparisonValue + 1, atomCount);
case 269484436:
return (comparisonValue < atomCount ? org.jmol.util.BitSetUtil.newBitSet (comparisonValue, comparisonValue + 1) :  new java.util.BitSet ());
case 269484438:
default:
...
bs =  new java.util.BitSet (atomCount);
...
if (propertyBitSet == null) continue ;if (atom.getModelIndex () != iModel) {
...
if (cellRange == null) continue ;comparisonValue = bitsetBaseValue % 1000;
var symop = Math.floor (bitsetBaseValue / 1000) - 1;
if (symop < 0) {
match = true;
} else if (nOps == 0 || symop >= 0 && !(match = propertyBitSet.get (symop))) {
continue ;}bitsetComparator = 1048587;
...
if (bitsetComparator != 269484435 && bitsetComparator != 269484434) continue ;}if (bitsetComparator == 269484438) {
if (comparisonValue > 0 && comparisonValue <= nOps && !propertyBitSet.get (comparisonValue)) {
bs.set (i);
}continue ;}}switch (bitsetComparator) {
case 269484435:
...
return (this.isSyntaxCheck ?  new java.util.BitSet () : this.viewer.getAtomBits (tokType, specInfo));
...
($fz = function (length) {
if (length >= 0) return this.checkLength (length, 0);
...
s = org.jmol.util.TextFormat.replaceAllCharacters (s, "{},[]\"'", ' ');
...
if (tok == 1073742195) tok = this.tokAt (i++);
if (tok != 269484096) this.error (22);
var fparams =  Clazz.newArray (nX, 0);
var n = 0;
while (tok != 269484097) {
tok = this.getToken (i).tok;
switch (tok) {
case 1073742195:
case 269484097:
continue ;case 269484080:
i++;
break;
case 269484096:
i++;
var f =  Clazz.newArray (nY, 0);
fparams[n++] = f;
for (var j = 0; j < nY; j++) {
...
if (Clazz.instanceOf (this.expressionResult, javax.vecmath.Point3f)) return this.expressionResult;
this.error (22);
break;
case 1048586:
case 8:
...
($fz = function (i) {
return this.centerParameter (i, -2147483648);
}, $fz.isPrivate = true, $fz), "~N");
Clazz.defineMethod (c$, "centerParameter", 
...
index = org.jmol.script.ScriptVariable.iValue (this.parameterExpressionList (-i - 1, -1, true).get (0));
if (this.getToken (--this.iToken).tok != 269484097) this.error (22);
}if (this.isSyntaxCheck) return  new javax.vecmath.Point3f ();
if (this.tokAt (i + 1) == 1048584 && (this.tokAt (i + 2) == 1141899267 || this.tokAt (i + 2) == 1141899270)) {
index = 2147483647;
this.iToken = i + 2;
}if ((center = this.getObjectCenter (id, index, modelIndex)) == null) this.error (12, id);
break;
case 10:
case 1048577:
case 1048586:
...
case 1048583:
var id = this.objectNameParameter (++i);
if (this.isSyntaxCheck) return  new javax.vecmath.Point4f ();
...
org.jmol.util.Measure.getPlaneThroughPoints (points[0], points[1], points[2],  new javax.vecmath.Vector3f (), vAB, vAC, plane =  new javax.vecmath.Point4f ());
break;
case 23:
...
break;
case 2:
var radiusRasMol = this.intParameter (1, 0, 750);
mad = radiusRasMol * 4 * 2;
break;
case 3:
mad = Math.round ((this.floatParameter (1, -3, 3) * 1000 * 2));
if (mad < 0) {
this.restrictSelected (false, false);
mad = -mad;
}break;
...
case 3:
var angstroms = this.floatParameter (index, 0, 2);
return Math.round ((angstroms * 1000 * 2));
}
this.error (7, "\"DOTTED\"");
return 0;
}, $fz.isPrivate = true, $fz), "~N");
...
var icolor = this.getArgbParam (index, allowNone);
...
continue ;}this.thisCommand = this.getCommand (this.pc, false, true);
...
if (milliSecDelay > 0) this.delay (-milliSecDelay);
...
continue ;}if (this.isSyntaxCheck) {
if (this.isCmdLine_c_or_C_Option) org.jmol.util.Logger.info (this.thisCommand);
if (this.statementLength == 1 && this.statement[0].tok != 135368713 && this.statement[0].tok != 102436) continue ;} else {
...
}if (this.theToken == null) continue ;if (org.jmol.script.Token.tokAttr (this.theToken.tok, 135168)) this.processShapeCommand (this.theToken.tok);
...
bsOrList = this.atomExpression (i);
...
v.intValue++;
}isOK = isOK && (Clazz.instanceOf (bsOrList, java.util.BitSet) ? org.jmol.script.ScriptVariable.bsSelect (v).cardinality () == 1 : v.intValue <= v.getList ().size ());
if (isOK) {
v = org.jmol.script.ScriptVariable.selectItem (v);
...
var cv = this.runFunction (trycmd, "try", null, null, true, true).value;
...
if (ct.contextVariables != null && ct.name0 != null) ct.contextVariables.put (ct.name0, org.jmol.script.ScriptVariable.getVariable (errMsg));
...
if (this.isSyntaxCheck) return ;
if (tv == null) tv = (v == null ? org.jmol.script.ScriptVariable.intVariable (0) : v);
t.value = tv.value;
...
if (!(Clazz.instanceOf (this.expressionResult, java.util.BitSet))) this.error (22);
...
center = this.centerParameter (i);
if (Clazz.instanceOf (this.expressionResult, java.util.BitSet)) bsCenter = this.expressionResult;
i = this.iToken + 1;
...
i = this.iToken;
if (!this.isSyntaxCheck) this.viewer.navigate (timeSec, pt);
continue ;case 528432:
switch (this.getToken (++i).tok) {
case 1112541205:
rotAxis.set (1, 0, 0);
i++;
...
if (!this.isSyntaxCheck) this.viewer.navigate (timeSec, rotAxis, degrees);
continue ;case 4160:
var x = NaN;
var y = NaN;
...
continue ;case 269484208:
continue ;case 1113200654:
var pathGuide;
var vp =  new java.util.ArrayList ();
var bs = this.atomExpression (++i);
i = this.iToken;
if (this.isSyntaxCheck) return ;
...
var indexStart = Math.round ((this.isFloatParameter (i + 1) ? this.floatParameter (++i) : 0));
var indexEnd = Math.round ((this.isFloatParameter (i + 1) ? this.floatParameter (++i) : 2147483647));
if (!this.isSyntaxCheck) this.viewer.navigate (timeSec, path, theta, indexStart, indexEnd);
continue ;}var v =  new java.util.ArrayList ();
...
if (!this.isSyntaxCheck) this.viewer.navigate (timeSec, path, theta, 0, 2147483647);
continue ;}default:
this.error (22);
}
}
...
var vAtomSets = null;
var vQuatSets = null;
var bsFrom = (this.tokAt (1) == 3158024 ? null : this.atomExpression (1));
var bsTo = (this.tokAt (++this.iToken) == 3158024 ? null : this.atomExpression (this.iToken));
...
break;
case 3158024:
bsSubset = this.atomExpression (++i);
i = this.iToken;
break;
case 10:
case 1048577:
if (vQuatSets != null) this.error (22);
bsAtoms1 = this.atomExpression (this.iToken);
var tok = (isToSubsetOfFrom ? 0 : this.tokAt (this.iToken + 1));
bsAtoms2 = (tok == 10 || tok == 1048577 ? this.atomExpression (++this.iToken) : org.jmol.util.BitSetUtil.copy (bsAtoms1));
if (bsSubset != null) {
...
isQuaternion = true;
data1 = org.jmol.script.ScriptMathProcessor.getQuaternionArray ((this.theToken).getList ());
this.getToken (++i);
data2 = org.jmol.script.ScriptMathProcessor.getQuaternionArray ((this.theToken).getList ());
...
if (bsSubset == null) {
bsAtoms1 = (isAtoms ? this.viewer.getAtomBitSet ("spine") :  new java.util.BitSet ());
...
}if (m == null) m =  new javax.vecmath.Matrix4f ();
var atoms = this.viewer.getModelSet ().atoms;
var atomCount = this.viewer.getAtomCount ();
...
}, "java.util.BitSet,java.util.BitSet,~S,java.util.List,java.util.List,javax.vecmath.Matrix4f,java.util.List,~B,~B");
Clazz.defineMethod (c$, "getSmilesMatches", 
function (pattern, smiles, bsSelected, bsMatch3D, isSmarts, asOneBitset) {
if (this.isSyntaxCheck) {
if (asOneBitset) return  new java.util.BitSet ();
return ["({})"];
}if (pattern.length == 0) {
...
var iarray =  Clazz.newArray (bs.cardinality (), 0);
var pt = 0;
for (var i = bs.nextSetBit (0); i >= 0; i = bs.nextSetBit (i + 1)) iarray[pt++] = i + 1;

return iarray;
}var matches =  new Array (b.length);
for (var j = 0; j < b.length; j++) matches[j] = org.jmol.util.Escape.escape (b[j], asAtoms);

return matches;
}, "~S,~S,java.util.BitSet,java.util.BitSet,~B,~B");
Clazz.defineMethod (c$, "connect", 
($fz = function (index) {
var distances =  Clazz.newArray (2, 0);
...
var addGroup = false;
if (this.statementLength == 1) {
if (!this.isSyntaxCheck) this.viewer.rebond (this.isStateScript);
return ;
...
if (haveType || isColorOrRadius) this.error (23);
atomSets[nAtomSets++] = this.atomExpression (i);
...
bs.set (atom1);
result = this.viewer.makeConnections (distances[0], distances[1], bondOrder, operation, bs, this.atomExpression (expression2), bsBonds, isBonds, false, 0);
...
if (!Float.isNaN (radius)) this.setShapeSize (1, Math.round ((radius * 2000)), null);
if (color != -2147483648) this.setShapeProperty (1, "color", Integer.$valueOf (color), bsBonds);
...
this.setShapeProperty (1, "translucency", translucency, bsBonds);
...
var bs = (tok == 1048577 || tok == 10 ? this.atomExpression (2) : null);
...
for (var iShape = 17; ; ) {
if (iShape != 26 && this.getShapeProperty (iShape, "checkID", data)) {
...
strColor = strColor += "=" + org.jmol.script.ScriptVariable.sValue (org.jmol.script.ScriptVariable.getVariable (this.stringParameterSet (i))).$replace ('\n', ' ');
i = this.iToken + 1;
...
if ((str.charAt (0)).charCodeAt (0) != ('_').charCodeAt (0)) return false;
for (var i = org.jmol.util.Elements.elementNumberMax; --i >= 0; ) {
...
break;
case 1073742094:
var argb = this.getArgbParam (++index, false);
...
data =  Clazz.newArray (this.viewer.getAtomCount (), 0);
...
scheme += "=" + org.jmol.script.ScriptVariable.sValue (org.jmol.script.ScriptVariable.getVariable (this.stringParameterSet (index))).$replace ('\n', ' ');
index = this.iToken + 1;
...
this.viewer.setCurrentColorRange (data, bsSelected);
}if (isIsosurface) {
...
if (isIsosurface && colorvalue1 != null) this.setShapeProperty (shapeType, "colorPhase", [colorvalue1, colorvalue]);
 ...
 else this.setShapeProperty (shapeType, prefix + "color", colorvalue, bs);
...
}this.setShapeProperty (shapeType, "color", Integer.$valueOf (argb), bs);
if (translucency != null) this.setShapeTranslucency (shapeType, "", translucency, translucentLevel, bs);
if (typeMask != 0) this.setShapeProperty (1, "type", Integer.$valueOf (1023));
}, $fz.isPrivate = true, $fz), "~N,~N,~N,~S,~N,java.util.BitSet");
...
if (bs == null) this.setShapeProperty (shapeType, prefix + "translucency", translucency);
 else if (!this.isSyntaxCheck) this.setShapeProperty (shapeType, prefix + "translucency", translucency, bs);
}, $fz.isPrivate = true, $fz), "~N,~S,~S,~N,java.util.BitSet");
...
bsTo = this.atomExpression (2);
property1 = property2 = "selected";
} else {
bsFrom = this.atomExpression (1);
...
bsTo = this.atomExpression (++this.iToken);
...
var dataOut =  Clazz.newArray (isProperty ? this.viewer.getAtomCount () : data3.length, 0);
bsOut =  new java.util.BitSet ();
...
if (F == null) continue ;bsOut.set (pt);
dataOut[(isProperty ? pt : nOut)] = F.floatValue ();
nOut++;
}
if (isProperty) this.viewer.setData (property2, [property2, dataOut, bsOut], this.viewer.getAtomCount (), 0, 0, 2147483647, 0);
...
this.error (-1, "Error: " + e.getMessage ());
}
} else if (Clazz.instanceOf (e$$, Error)) {
var er = e$$;
{
this.viewer.setSelectionSubset (bsSubset);
this.error (-1, "Error: " + er.getMessage ());
}
} else {
throw e$$;
}
...
var eArray =  Clazz.newArray (n + 1, 0);
...
var atomCount = this.viewer.getAtomCount ();
var atomMap = null;
var bsTemp =  new java.util.BitSet (atomCount);
if (atomNumberField > 0) {
atomMap =  Clazz.newArray (atomCount + 2, 0);
...
if (atomNo > atomCount + 1 || atomNo < 0 || bsTemp.get (atomNo)) continue ;bsTemp.set (atomNo);
atomMap[atomNo] = j;
}
this.$data[2] = atomMap;
} else {
...
var bs = this.atomExpression (2);
this.definedAtomSets.put (setName, bs);
if (!this.isSyntaxCheck) this.viewer.setUserVariable ("@" + setName, org.jmol.script.ScriptVariable.getVariable (bs));
}}, $fz.isPrivate = true, $fz));
...
loadScript.append (" ").append (org.jmol.util.Escape.escape (key));
...
if (key.indexOf ("@") < 0) {
loadScript.append (" end ").append (org.jmol.util.Escape.escape (key));
i += 2;
}break;
case 1073741839:
isAppend = true;
...
i = this.iToken + 1;
htParams.put ("firstLastStep", [Math.round (pt.x), Math.round (pt.y), Math.round (pt.z)]);
loadScript.append (" " + org.jmol.util.Escape.escape (pt));
...
sOptions += " MANIFEST " + org.jmol.util.Escape.escape (manifest);
tok = this.tokAt (++i);
}switch (tok) {
case 2:
...
i = this.iToken;
var bs =  new java.util.BitSet ();
for (var j = 0; j < data.length; j++) if (data[j] >= 1 && data[j] == Math.round (data[j])) bs.set (Math.round (data[j]) - 1);

htParams.put ("bsModels", bs);
var iArray =  Clazz.newArray (bs.cardinality (), 0);
for (var pt = 0, j = bs.nextSetBit (0); j >= 0; j = bs.nextSetBit (j + 1)) iArray[pt++] = j + 1;

sOptions += " " + org.jmol.util.Escape.escapeArray (iArray);
tok = this.tokAt (i);
break;
}
var lattice = null;
...
if (this.isPoint3f (++i)) {
var pt = this.getPoint3f (i, false);
if (pt.x != Math.round (pt.x) || pt.y != Math.round (pt.y) || pt.z != Math.round (pt.z) || pt.x < 1 || pt.y < 1 || pt.z < 1) {
this.iToken = i;
this.error (22);
}supercell = pt;
i = this.iToken + 1;
...
sOptions += " spacegroup " + org.jmol.util.Escape.escape (spacegroup);
...
sOptions += " offset " + org.jmol.util.Escape.escape (offset);
...
if (pt != null) {
firstLastSteps.add ([Math.round (pt.x), Math.round (pt.y), Math.round (pt.z)]);
loadScript.append (" COORD " + org.jmol.util.Escape.escape (pt));
} else if (bs != null) {
...
sOptions += " FILTER " + org.jmol.util.Escape.escape (filter);
...
loadScript =  new StringBuffer ("{\n    var " + filename.substring (1) + " = " + org.jmol.util.Escape.escape (s) + ";\n    " + loadScript);
}}var os = null;
if (localName != null) {
...
loadScript.append (org.jmol.util.Escape.escape (filename));
} else if (!isData) {
...
loadScript.append ((localName != null ? org.jmol.util.Escape.escape (localName) : "$FILENAME$"));
...
}if (this.scriptLevel == 0 && !isAppend && nFiles < 2) this.showString (this.viewer.getModelSetAuxiliaryInfo ("modelLoadNote"));
...
var moData = this.viewer.getModelAuxiliaryInfo (i, "moData");
...
var atomIndex = -1;
var ptFloat = -1;
var countPlusIndexes =  Clazz.newArray (5, 0);
...
bs2.and (this.viewer.getAtomsWithin (5, bs, false, null));
points.add (bs2);
}break;
case 10:
case 1048577:
...
if (rd == null) rd =  new org.jmol.atomdata.RadiusData (rangeMinMax);
...
($fz = function (args) {
var modelIndex = this.viewer.getCurrentModelIndex ();
if (modelIndex < 0) this.error (30, "plot");
...
case 135270421:
makeNewFrame = false;
if (this.tokAt (pt, args) == 4) {
filename = this.stringParameter (pt--);
} else if (this.tokAt (pt - 1, args) == 1048584) {
...
var color = (org.jmol.g3d.Graphics3D.getHexCode (this.viewer.getColixBackgroundContrast ()));
...
var f = data[i];
if (Float.isNaN (f)) continue ;if (isMax == (f > fmax)) fmax = f;
}
return fmax;
...
}if (this.viewer.autoExit || !this.viewer.haveDisplay) return false;
...
return ;
case 1641025539:
var bsAllAtoms =  new java.util.BitSet ();
...
if (($var.charAt (0)).charCodeAt (0) == ('_').charCodeAt (0)) this.error (22);
...
for (var shapeType = 21; --shapeType >= 0; ) if (shapeType != 6) this.setShapeSize (shapeType, 0, null);
...
bsAtoms = this.atomExpression (i);
ptsB = null;
isSelected = true;
break;
}}haveRotation = true;
if (nPoints == 2) nPoints = 0;
var pt1 = this.centerParameter (i, this.viewer.getCurrentModelIndex ());
...
case 1611141175:
isSpin = true;
continue ;case 1073741988:
case 1073742030:
isMolecular = true;
continue ;case 1114638350:
isSelected = true;
break;
case 269484080:
continue ;case 2:
...
continue ;} else if (endDegrees == 3.4028235E38) {
endDegrees = degreesPerSecond;
degreesPerSecond = this.floatParameter (i);
continue ;}} else {
if (endDegrees == 3.4028235E38) {
endDegrees = this.floatParameter (i);
continue ;} else if (degreesPerSecond == 1.4E-45) {
degreesPerSecond = this.floatParameter (i);
isSpin = true;
continue ;}}this.error (22);
break;
case 269484192:
direction = -1;
continue ;case 1112541205:
haveRotation = true;
rotAxis.set (direction, 0, 0);
continue ;case 1112541206:
haveRotation = true;
rotAxis.set (0, direction, 0);
continue ;case 1112541207:
haveRotation = true;
...
endDegrees = p4.w;
q =  new org.jmol.util.Quaternion (rotAxis, endDegrees);
break;
case 1048580:
haveRotation = true;
var iAtom1 = this.atomExpression (++i).nextSetBit (0);
var iAtom2 = this.atomExpression (++this.iToken).nextSetBit (0);
...
case 137363468:
helicalPath = true;
continue ;case 1297090050:
var symop = this.intParameter (++i);
if (this.isSyntaxCheck) continue ;var info = this.viewer.getSpaceGroupInfo (null);
...
rotAxis.normalize ();
org.jmol.util.Measure.getPlaneThroughPoint (points[0], rotAxis, invPlane =  new javax.vecmath.Point4f ());
}q =  new org.jmol.util.Quaternion (rotAxis, endDegrees);
nPoints = (points[0] == null ? 0 : 1);
isMolecular = true;
haveRotation = true;
isSelected = true;
continue ;case 135270405:
case 12:
case 11:
haveRotation = true;
if (tok == 135270405) {
bsCompare = this.atomExpression (++i);
ptsA = this.viewer.getAtomPointVector (bsCompare);
if (ptsA == null) this.error (22, i);
i = this.iToken;
ptsB = this.getPointVector (this.getToken (++i), i);
if (ptsB == null || ptsA.size () != ptsB.size ()) this.error (22, i);
m4 =  new javax.vecmath.Matrix4f ();
points[0] =  new javax.vecmath.Point3f ();
nPoints = 1;
...
this.viewer.invertAtomCoord (invPoint, bsAtoms);
if (rotAxis == null) return ;
}if (invPlane != null) {
this.viewer.invertAtomCoord (invPlane, bsAtoms);
if (rotAxis == null) return ;
}if (nPoints < 2) {
if (!isMolecular) {
...
return  new org.jmol.util.Quaternion (p4);
}return  new org.jmol.util.Quaternion (this.getPoint4f (i));
}, $fz.isPrivate = true, $fz), "~N");
...
if (i > 0) return this.viewer.getAtomPointVector (this.atomExpression (i));
return null;
...
return (this.getShapeProperty (22, "getCenter", data) || this.getShapeProperty (23, "getCenter", data) || this.getShapeProperty (24, "getCenter", data) || this.getShapeProperty (26, "getCenter", data) ? data[2] : null);
}, $fz.isPrivate = true, $fz), "~S,~N,~N");
Clazz.defineMethod (c$, "getObjectBoundingBox", 
($fz = function (id) {
var data = [id, null, null];
return (this.getShapeProperty (23, "getBoundingBox", data) || this.getShapeProperty (24, "getBoundingBox", data) || this.getShapeProperty (26, "getBoundingBox", data) ? data[2] : null);
}, $fz.isPrivate = true, $fz), "~S");
Clazz.defineMethod (c$, "getDrawObjectAxis", 
($fz = function (axisID, index) {
var data = [axisID, Integer.$valueOf (index), null];
return (this.getShapeProperty (22, "getSpinAxis", data) ? data[2] : null);
}, $fz.isPrivate = true, $fz), "~S,~N");
...
this.contextVariables =  new java.util.Hashtable ();
this.contextVariables.put ("_arguments", org.jmol.script.ScriptVariable.getVariable (params == null ? [] : params));
...
if (this.isSyntaxCheck) return ;
this.runFunction (null, name, params, null, false, true);
}, $fz.isPrivate = true, $fz));
...
break;
default:
if (this.statementLength == 4 && this.tokAt (2) == 1678770178) bs =  new org.jmol.modelset.Bond.BondSet (org.jmol.util.BitSetUtil.newBitSet (0, this.viewer.getModelSet ().getBondCount ()));
 else bs = this.atomExpression (i);
}
if (this.isSyntaxCheck) return ;
if (Clazz.instanceOf (bs, org.jmol.modelset.Bond.BondSet)) {
this.viewer.displayBonds (bs, isDisplay);
return ;
}this.viewer.display (bs, isDisplay, isGroup, addRemove, this.tQuiet);
}, $fz.isPrivate = true, $fz), "~B");
...
var n = 0;
var targetValue = 0;
var aList =  Clazz.newArray (5, 0);
if (this.tokAt (++i) == 1073741882) {
this.checkLength (3);
} else {
while (n < 4 && !this.isFloatParameter (i)) {
aList[++n] = this.atomExpression (i).nextSetBit (0);
i = this.iToken + 1;
}
aList[0] = n;
if (n == 1) this.error (22);
targetValue = this.floatParameter (this.checkLast (i));
}if (!this.isSyntaxCheck) this.viewer.getMinimizer (true).setProperty ("constraint", [aList,  Clazz.newArray (n, 0), Float.$valueOf (targetValue)]);
return ;
case 1073741905:
crit = this.floatParameter (++i);
continue ;case 1073741935:
steps = 0;
continue ;case 1060869:
if (i != 1) this.error (22);
bsFixed = this.atomExpression (++i);
...
continue ;case 135280132:
bsSelected = this.atomExpression (++i);
i = this.iToken;
continue ;case 1073742148:
isSilent = true;
break;
case 266298:
...
if (this.statementLength != 1 && (this.statementLength != 4 || !this.getToken (2).value.equals ("off"))) bs = this.atomExpression (1);
...
this.viewer.invertAtomCoord (pt, bs);
return ;
case 528443:
iAtom = this.atomExpression (2).nextSetBit (0);
bs = this.atomExpression (this.iToken + 1);
break;
case 135266320:
pt = this.centerParameter (2);
break;
...
var pt = this.getPoint3f (i, true);
bs = (!isSelected && this.iToken + 1 < this.statementLength ? this.atomExpression (++this.iToken) : null);
this.checkLast (this.iToken);
if (!this.isSyntaxCheck) this.viewer.setAtomCoordRelative (pt, bs);
return ;
}var xyz = this.getToken (i).tok;
if (xyz != 1112541205 && xyz != 1112541206 && xyz != 1112541207) this.error (0);
...
this.iToken = ((type).charCodeAt (0) == ('\0').charCodeAt (0) ? 2 : 3);
bs = (isSelected ? this.viewer.getSelectionSet (false) : this.iToken + 1 < this.statementLength ? this.atomExpression (++this.iToken) : null);
this.checkLast (this.iToken);
if (!this.isSyntaxCheck) this.viewer.translate (this.parameterAsString (1).charAt (0), amount, type, bs);
}, $fz.isPrivate = true, $fz), "~B");
...
if (center != null) {
var bs = this.atomExpression (ptCenter);
...
r = this.viewer.calcRotationRadius (bs);
...
return zoom;
}, $fz.isPrivate = true, $fz), "~N,~N,java.util.BitSet,~N");
...
break;
case 3:
millis = Math.round ((this.floatParameter (1) * 1000));
break;
default:
this.error (34);
}
if (!this.isSyntaxCheck) this.delay (millis);
}, $fz.isPrivate = true, $fz));
Clazz.defineMethod (c$, "delay", 
($fz = function (millis) {
...
this.setShapeProperty (20, "select", Integer.$valueOf (this.intParameter (2, 1, 3)));
return ;
case 1074790550:
case 269484209:
case 1073741824:
...
i = this.iToken;
}if (value == null) continue ;if (!Float.isNaN (translucentLevel)) this.setShapeProperty (20, "translucentLevel", Float.$valueOf (translucentLevel));
key = "translucency";
break;
case 12291:
value = Boolean.TRUE;
...
if (rd == null) rd =  new org.jmol.atomdata.RadiusData (scale, org.jmol.atomdata.RadiusData.RadiusData.EnumType.FACTOR, org.jmol.constant.EnumVdw.AUTO);
...
var value = NaN;
var factorType = org.jmol.atomdata.RadiusData.RadiusData.EnumType.ABSOLUTE;
var vdwType = null;
...
case 1649412112:
value = 1;
factorType = org.jmol.atomdata.RadiusData.RadiusData.EnumType.FACTOR;
...
if (value > 0) {
value /= 250;
factorType = org.jmol.atomdata.RadiusData.RadiusData.EnumType.ABSOLUTE;
} else {
value /= -100;
factorType = org.jmol.atomdata.RadiusData.RadiusData.EnumType.FACTOR;
}break;
}value = this.floatParameter (index, (isOnly || !allowAbsolute ? -16 : 0), 16);
if (tok == 269484193 || !allowAbsolute) {
factorType = org.jmol.atomdata.RadiusData.RadiusData.EnumType.OFFSET;
} else {
factorType = org.jmol.atomdata.RadiusData.RadiusData.EnumType.ABSOLUTE;
...
}}return  new org.jmol.atomdata.RadiusData (value, factorType, vdwType);
}, $fz.isPrivate = true, $fz), "~N,~B,~B");
...
break;
case 2:
value = this.intParameter (1, 0, 19);
break;
case 3:
type = org.jmol.atomdata.RadiusData.RadiusData.EnumType.ABSOLUTE;
value = this.floatParameter (1, 0, 3);
break;
default:
this.error (6);
}
...
this.setFloatProperty ("vectorScale", this.floatParameter (2, -100, 100));
return ;
}}
this.setShapeSize (18,  new org.jmol.atomdata.RadiusData (value, type, null));
}, $fz.isPrivate = true, $fz));
...
propertyValue = this.atomExpression (i);
i = this.iToken;
iHaveAtoms = true;
break;
case 1048586:
...
propertyValue = Integer.$valueOf (Math.round (v));
} else {
propertyName = "offset";
...
break;
case 1073742138:
this.setFloatProperty ("vibrationScale", this.floatParameter (2, -10, 10));
return ;
case 1073742090:
...
this.checkLength (++i);
if (direction != 1 && direction != -1) this.error (35, "-1", "1");
...
if (asDSSP) bs1 = this.viewer.getSelectionSet (false);
 else bs1 = this.atomExpression (this.iToken);
if (!asDSSP && !(asDSSP = (this.tokAt (++this.iToken) == 1641025539))) bs2 = this.atomExpression (this.iToken);
if (!this.isSyntaxCheck) {
n = this.viewer.autoHbond (bs1, bs2, false);
break;
}return ;
case 1613758476:
bs = (this.statementLength == 2 ? null : this.atomExpression (2));
this.checkLast (this.iToken);
...
case 1641025539:
bs = (this.statementLength < 4 ? null : this.atomExpression (2));
...
return ;
case 1708058:
bs = (this.iToken + 1 < this.statementLength ? this.atomExpression (++this.iToken) : null);
bs2 = (this.iToken + 1 < this.statementLength ? this.atomExpression (++this.iToken) : null);
this.checkLength (++this.iToken);
if (!this.isSyntaxCheck) {
n = this.viewer.calculateStruts (bs, bs2);
if (n > 0) this.colorShape (4, 32768, 0x0FFFFFF, "translucent", 0.5, null);
...
bs = (this.iToken + 1 < this.statementLength ? this.atomExpression (++this.iToken) : this.viewer.getSelectionSet (false));
this.checkLength (++this.iToken);
...
var value = NaN;
var type = org.jmol.atomdata.RadiusData.RadiusData.EnumType.ABSOLUTE;
var ipt = 1;
switch (this.getToken (ipt).tok) {
case 1073742072:
this.restrictSelected (false, false);
value = 1;
type = org.jmol.atomdata.RadiusData.RadiusData.EnumType.FACTOR;
break;
case 1048589:
value = 1;
type = org.jmol.atomdata.RadiusData.RadiusData.EnumType.FACTOR;
...
var rd = (Float.isNaN (value) ? this.encodeRadiusParameter (ipt, false, true) :  new org.jmol.atomdata.RadiusData (value, type, org.jmol.constant.EnumVdw.AUTO));
if (Float.isNaN (rd.value)) this.error (22);
...
break;
case 2:
mad = (this.intParameter (1, 0, 1000) * 8);
break;
case 3:
mad = Math.round ((this.floatParameter (1, -4.0, 4.0) * 2000));
if (mad < 0) {
this.restrictSelected (false, false);
mad = -mad;
}break;
...
this.setShapeSize (shapeType, mad, null);
}, $fz.isPrivate = true, $fz), "~N");
...
var index = this.atomExpression (2).nextSetBit (0);
var index2 = -1;
var type = null;
if (index < 0) this.error (22);
if (atomsOrBonds == 4106) {
index2 = this.atomExpression (++this.iToken).nextSetBit (0);
} else {
...
($fz = function () {
var bs = (this.statementLength == 1 ? null : this.atomExpression (1));
if (this.isSyntaxCheck) return ;
...
case 1048577:
case 10:
var i = this.atomExpression (1).nextSetBit (0);
this.checkLength (this.iToken + 1);
if (this.isSyntaxCheck || i < 0) return ;
var bsa =  new java.util.BitSet ();
bsa.set (i);
...
case 2:
case 3:
millis = Math.round ((this.floatParameter (2) * 1000));
break;
default:
this.error (20);
}
...
return ;
case 1073742166:
if (this.checkLength23 () > 0) if (!this.isSyntaxCheck) this.viewer.setFrameTitle (this.statementLength == 2 ? "@{_modelName}" : (this.tokAt (2) == 7 ? org.jmol.script.ScriptVariable.listValue (this.statement[2]) : this.parameterAsString (2)));
return ;
case 1073741832:
var bs = (this.statementLength == 2 || this.tokAt (2) == 1048587 ? null : this.atomExpression (2));
...
}if (this.theTok == 3 && haveFileSet && fFrame == Math.round (fFrame)) iFrame = Math.round (fFrame) * 1000000;
...
if (!this.isSyntaxCheck) this.viewer.setAnimation (1073742108);
return ;
}if (iFrame >= 1000 && iFrame < 1000000 && haveFileSet) iFrame = (Math.floor (iFrame / 1000)) * 1000000 + (iFrame % 1000);
...
return ;
}}if (!isPlay && !isRange || modelIndex >= 0) this.viewer.setCurrentModelIndex (modelIndex, false);
...
function (m) {
var bs =  new java.util.BitSet (this.viewer.getAtomCount ());
if (this.isSyntaxCheck) return bs;
var modelCount = this.viewer.getModelCount ();
var haveFileSet = this.viewer.haveFileSet ();
...
if (org.jmol.g3d.Graphics3D.getFontStyleID (fontface) >= 0) {
fontstyle = fontface;
fontface = "SansSerif";
...
case 536870920:
this.shapeManager.loadShape (8);
this.setShapeProperty (8, "highlight", (this.tokAt (2) == 1048588 ? null : this.atomExpression (2)));
return ;
case 1610625028:
case 1611141171:
...
var ijk = org.jmol.script.ScriptVariable.iValue ($var);
if (ijk < 555) pt =  new javax.vecmath.Point3f ();
...
break;
default:
this.error (50, "set SPIN ", sval);
}
if (!this.isSyntaxCheck) this.viewer.setSpin (sval, Math.round (this.floatParameter (this.checkLast (3))));
justShow = true;
break;
}
}if (newTok != 0) {
...
if (key.length == 0 || (key.charAt (0)).charCodeAt (0) == ('_').charCodeAt (0)) this.error (56);
...
this.iToken = 1;
if (!this.isStateScript) this.error (50, "SET", key);
...
var pt = (tok2 == 269484436 ? 3 : setType == ('=').charCodeAt (0) && !key.equals ("return") && tok2 != 269484436 ? 0 : 2);
...
this.checkLength (3);
this.setIntProperty ("zSlab", Math.round (this.floatParameter (2)));
} else {
...
case 554176526:
propertyName = "%zpos";
propertyValue = Integer.$valueOf (Math.round (this.floatParameter (pt++)));
break;
case 1610625028:
case 3145768:
case 1048589:
...
return org.jmol.script.ScriptVariable.iValue (this.parameterExpressionToken (pt));
}, $fz.isPrivate = true, $fz), "~N");
...
var xOffset = this.intParameter (2, -127, 127);
var yOffset = this.intParameter (3, -127, 127);
...
this.iToken = 1;
var bs = (this.statementLength == 2 ? null : this.atomExpression (2));
this.checkLast (this.iToken);
...
var bs = (this.iToken + 1 < this.statementLength ? this.atomExpression (++this.iToken) : null);
this.checkLast (this.iToken);
if (this.isSyntaxCheck) return true;
if (bs == null) this.setShapeProperty (5, str, propertyValue);
 else this.setShapeProperty (5, str, propertyValue, bs);
return true;
}, $fz.isPrivate = true, $fz), "~S");
...
this.error (50, "set " + org.jmol.script.Token.nameOf (tok), units);
}return true;
}, $fz.isPrivate = true, $fz), "~S,~N");
...
mode = 0;
if (mode < 0) this.error (50, "SET PICKING " + type, str);
...
var propertyName = "";
var tokProperty = 0;
var isArrayItem = (setType == ('[').charCodeAt (0));
...
if (needVariable) {
if (key.startsWith ("_")) this.error (22, key);
t = this.viewer.getOrSetNewVariable (key, true);
isUserVariable = true;
}if (isArrayItem) {
var tnew = ( new org.jmol.script.ScriptVariable ()).set (tv, false);
var nParam = Math.floor (v.size () / 2);
...
var ipt = org.jmol.script.ScriptVariable.iValue (vv);
if (t.tok == 7) t = org.jmol.script.ScriptVariable.selectItem (t);
switch (t.tok) {
case 7:
var list = t.getList ();
...
if (nParam == 2) {
var ipt2 = org.jmol.script.ScriptVariable.iValue (v.get (2));
...
this.viewer.setData (propertyName, [propertyName, tv.tok == 7 ? org.jmol.script.ScriptVariable.flistValue (tv, (tv.value).size () == bs.cardinality () ? bs.cardinality () : this.viewer.getAtomCount ()) : tv.asString (), org.jmol.util.BitSetUtil.copy (bs)], this.viewer.getAtomCount (), 0, 0, tv.tok == 7 ? 2147483647 : -2147483648, 0);
return ;
}this.setBitsetProperty (bs, tokProperty, org.jmol.script.ScriptVariable.iValue (tv), org.jmol.script.ScriptVariable.fValue (tv), tv);
return ;
}if (isUserVariable) {
t.set (tv, false);
return ;
...
this.viewer.setData (key, [key, "" + vv, org.jmol.util.BitSetUtil.copy (this.viewer.getSelectionSet (false))], this.viewer.getAtomCount (), 0, 0, -2147483648, 0);
return ;
...
this.setStringProperty (key, org.jmol.util.Escape.escape (vv, false));
} else if (Clazz.instanceOf (vv, java.util.BitSet) || Clazz.instanceOf (vv, javax.vecmath.Point3f) || Clazz.instanceOf (vv, javax.vecmath.Point4f)) {
...
} else if (this.expressionResult != null && Clazz.instanceOf (this.expressionResult, java.util.BitSet)) {
...
if (icell != 2147483647) this.viewer.setCurrentUnitCellOffset (icell);
 ...
 else if (points != null) this.viewer.setCurrentUnitCell (points);
this.setObjectMad (32, "unitCell", mad);
if (pt != null) this.viewer.setCurrentUnitCellOffset (pt);
...
var scripts = null;
var type = "SPT";
var tok = (isCommand && args.length == 1 ? 1073741884 : this.tokAt (pt, args));
switch (tok) {
case 0:
break;
case 4:
...
break;
case 4166:
nVibes = this.intParameter (++pt, 1, 10);
if (!this.isSyntaxCheck) {
this.viewer.setVibrationOff ();
this.delay (100);
}pt++;
...
if (this.isSyntaxCheck) return "";
} else if (org.jmol.util.Parser.isOneOf (val.toLowerCase (), "png;pngj;pngt;jpg;jpeg;jpg64;jpeg64") && this.tokAt (pt + 1, args) == 2) {
...
if (data.length > 0 && (data.charAt (0)).charCodeAt (0) != ('.').charCodeAt (0)) type = val.toUpperCase ();
...
if (pt == argCount - 3 && this.tokAt (pt + 1, args) == 1048584) {
fileName += "." + org.jmol.script.ScriptVariable.sValue (this.tokenAt (pt + 2, args));
}if (type !== "VAR" && pt == pt0) type = "IMAGE";
 else if (fileName.length > 0 && (fileName.charAt (0)).charCodeAt (0) == ('.').charCodeAt (0) && (pt == pt0 + 1 || pt == pt0 + 2)) {
...
if (!type.equals ("PNGJ") && !type.equals ("ZIPALL")) this.error (22);
 ...
 else if (!isImage && !isExport && !org.jmol.util.Parser.isOneOf (type, "SCENE;JMOL;ZIP;ZIPALL;SPT;HISTORY;MO;ISOSURFACE;MESH;PMESH;VAR;FILE;FUNCTION;CD;CML;XYZ;XYZRN;XYZVIB;MENU;MOL;PDB;PGRP;PQR;QUAT;RAMA;SDF;V2000;V3000;")) this.error (54, "COORDS|FILE|FUNCTIONS|HISTORY|IMAGE|ISOSURFACE|JMOL|MENU|MO|POINTGROUP|QUATERNION [w,x,y,z] [derivative]|RAMACHANDRAN|SPT|STATE|VAR x|ZIP|ZIPALL  CLIPBOARD", "CML|GIF|JPG|JPG64|JMOL|JVXL|MESH|MOL|PDB|PMESH|PNG|PNGJ|PNGT|PPM|PQR|SDF|V2000|V3000|SPT|XJVXL|XYZ|XYZRN|XYZVIB|ZIP" + driverList.toUpperCase ().$replace (';', '|'));
if (this.isSyntaxCheck) return "";
data = type.intern ();
var bytes = null;
var doDefer = false;
...
msg = this.viewer.createImage (fileName, ext, data, null, -2147483648, 0, 0, null, 0, fullPath);
...
if (doDefer) msg = this.viewer.streamFileData (fileName, type, type2, 0, null);
 else msg = this.viewer.createImage (fileName, type, bytes, scripts, quality, width, height, bsFrames, nVibes, fullPath);
...
if (this.isSyntaxCheck) return ;
var modelIndex = this.viewer.getCurrentModelIndex ();
if (modelIndex < 0) this.error (30, "show " + this.theToken.value);
...
break;
case 536870918:
value = org.jmol.util.Escape.escape (this.viewer.getDefaultLattice ());
break;
case 4126:
...
break;
case 1073741828:
msg = org.jmol.util.Escape.escapeArray (this.viewer.getAdditionalHydrogens (null, true, true, null));
break;
case 1613758476:
...
msg = (data == null ? "no data" : "data  \"" + data[0] + "\"\n" + (Clazz.instanceOf (data[1], Array) ? org.jmol.util.Escape.escape (data[1], false) : Clazz.instanceOf (data[1], Array) ? org.jmol.util.Escape.escape (data[1], false) : "" + data[1]) + "\nend \"" + data[0] + "\";");
}break;
case 1073742152:
var info = null;
if ((len = this.statementLength) == 2) {
...
case 12289:
if (!this.isSyntaxCheck) msg = "center " + org.jmol.util.Escape.escape (this.viewer.getRotationCenter ());
break;
case 135176:
...
var modelIndex = this.viewer.getCurrentModelIndex ();
if (modelIndex < 0) this.error (30, "MO isosurfaces");
var moData = this.viewer.getModelAuxiliaryInfo (modelIndex, "moData");
...
return this.getShapeProperty (26, "showMO", ptMO);
}, $fz.isPrivate = true, $fz), "~N");
...
break;
case 4106:
connections =  Clazz.newArray (4, 0);
iConnect = 4;
var farray = this.floatParameterSet (++i, 4, 4);
i = this.iToken;
for (var j = 0; j < 4; j++) connections[j] = Math.round (farray[j]);
...
iConnect = 0;
connections = [-1, -1, -1, -1];
}connections[iConnect++] = this.atomExpression (++i).nextSetBit (0);
i = this.iToken;
connections[iConnect++] = (this.theTok == 1678770178 ? this.atomExpression (++i).nextSetBit (0) : -1);
i = this.iToken;
havePoints = true;
break;
case 554176565:
...
case 11:
case 12:
var sv =  new org.jmol.script.ScriptVariable (this.theToken);
sv.toArray ();
...
var polygons =  Clazz.newArray (nTriangles, 0);
...
polygons[j] = [Math.round (f[0]), Math.round (f[1]), Math.round (f[2]), (f.length == 3 ? 7 : Math.round (f[3]))];
}
if (nVertices > 0) {
v.add (points);
v.add (polygons);
...
center = this.centerParameter (++i);
bsAtoms = (this.tokAt (i) == 10 || this.tokAt (i) == 1048577 ? this.atomExpression (i) : null);
i = this.iToken + 1;
}this.checkLast (this.iToken);
...
if (isFrame) {
this.checkLast (this.iToken);
if (!this.isSyntaxCheck) this.runScript (( new org.jmol.util.Quaternion (propertyValue)).draw ((thisId == null ? "frame" : thisId), " " + swidth, (center == null ?  new javax.vecmath.Point3f () : center), intScale / 100));
return ;
...
swidth = propertyName + (this.tokAt (i) == 3 ? " " + f : " " + (Math.round (f)));
break;
case 1048583:
...
if (params == null) params =  Clazz.newArray (1, 0);
...
bs = org.jmol.util.BitSetUtil.copy (this.atomExpression (i));
i = this.iToken;
if (bsA == null) bsA = bs;
 else bsB = bs;
...
if (this.isSyntaxCheck) return ;
if (bsA != null) {
var rd1 = (rd == null ?  new org.jmol.atomdata.RadiusData (0.26, org.jmol.atomdata.RadiusData.RadiusData.EnumType.OFFSET, org.jmol.constant.EnumVdw.AUTO) : rd);
...
params = (params == null ?  Clazz.newArray (2, 0) : org.jmol.util.ArrayUtil.ensureLength (params, 2));
...
if (Clazz.instanceOf (volume, Array)) {
var vs = volume;
var v = 0;
...
if (setBfirst) {
bs = this.viewer.getAtomsWithin (distance, bsA, withinAllModels, (Float.isNaN (distance) ? rd : null));
bsB.and (bs);
}if (localOnly) {
bs = this.viewer.getAtomsWithin (distance, bsB, withinAllModels, (Float.isNaN (distance) ? rd : null));
bsA.and (bs);
if (!setBfirst) {
bs = this.viewer.getAtomsWithin (distance, bsA, withinAllModels, (Float.isNaN (distance) ? rd : null));
bsB.and (bs);
...
}, "java.util.BitSet,java.util.BitSet,~B,~N,org.jmol.atomdata.RadiusData,~B");
...
propertyName = "select";
propertyValue = this.atomExpression (i + 1);
i = this.iToken;
} else {
...
if (this.isColorParam (i + 1)) {
slabColix = Short.$valueOf (org.jmol.g3d.Graphics3D.getColixTranslucent (org.jmol.g3d.Graphics3D.getColix (this.getArgbParam (i + 1)), slabTranslucency != 0, slabTranslucency));
i = this.iToken;
} else {
slabColix = Short.$valueOf (org.jmol.g3d.Graphics3D.getColixTranslucent (1, slabTranslucency != 0, slabTranslucency));
...
if (this.isSyntaxCheck || !(Clazz.instanceOf (this.expressionResult, java.util.BitSet))) {
pts = [pt];
} else {
var atoms = this.viewer.getModelSet ().atoms;
...
var iType = Math.round (unitCell.getUnitCellInfo (6));
var v1 = null;
var v2 = null;
switch (iType) {
case 3:
...
d = this.floatParameter (++i);
if (!this.isFloatParameter (i + 1)) return  new Integer (Math.round (d));
d2 = this.floatParameter (++i);
data = [Float.$valueOf (d), Float.$valueOf (d2)];
tok = 1073742114;
break;
...
moNumber = i;
break;
}continue ;} else if ((f = mo.get ("energy")) != null) {
if (f.floatValue () > 0) {
moNumber = i;
break;
}continue ;}break;
...
}if (moNumber < 1 || moNumber > nOrb) this.error (26, "" + nOrb);
...
}sbCommand.append (" boundBox " + org.jmol.util.Escape.escape (pts[0]) + " " + org.jmol.util.Escape.escape (pts[pts.length - 1]));
...
break;
case 135267842:
bsSelect = this.atomExpression (++i);
if (this.isSyntaxCheck) {
bs =  new java.util.BitSet ();
} else if (this.tokAt (this.iToken + 1) == 1048577 || this.tokAt (this.iToken + 1) == 10) {
bs = this.atomExpression (++this.iToken);
bs.and (this.viewer.getAtomsWithin (5.0, bsSelect, false, null));
} else {
bs = this.viewer.getAtomsWithin (5.0, bsSelect, true, null);
...
sbCommand.append (" function ").append (org.jmol.util.Escape.escape (f));
...
if (this.fullCommand.indexOf ("# WITHIN=") >= 0) bs = org.jmol.util.Escape.unescapeBitset (org.jmol.util.Parser.getQuotedAttribute (this.fullCommand, "# WITHIN"));
 else if (!havePt) bs = (Clazz.instanceOf (this.expressionResult, java.util.BitSet) ? this.expressionResult : null);
if (!this.isSyntaxCheck) {
...
sbCommand.append (" within ").append (distance).append (" ").append (bs == null ? org.jmol.util.Escape.escape (ptc) : org.jmol.util.Escape.escape (bs));
...
if (surfaceObjectSeen) sbCommand.append (" vdw");
...
if (surfaceObjectSeen) sbCommand.append (" ").append (str);
if (str.toLowerCase ().indexOf ("property_") == 0) {
data =  Clazz.newArray (this.viewer.getAtomCount (), 0);
if (this.isSyntaxCheck) continue ;data = this.viewer.getDataFloat (str);
if (data == null) this.error (22);
this.addShapeProperty (propertyList, propertyName, data);
continue ;}var atomCount = this.viewer.getAtomCount ();
data =  Clazz.newArray (atomCount, 0);
if (isVariable) {
...
}if (!this.isSyntaxCheck && (surfaceObjectSeen)) sbCommand.append (" \"\" ").append (org.jmol.util.Escape.escape (data));
} else {
...
discreteColixes = org.jmol.g3d.Graphics3D.getColixArray (colorScheme);
...
i = this.iToken;
continue ;}if ((this.theTok = this.tokAt (i + 1)) == 1073742180 || this.theTok == 1073742074) {
sbCommand.append (" color");
translucency = this.setColorOptions (sbCommand, i + 1, 23, -2);
i = this.iToken;
continue ;}switch (this.tokAt (i + 1)) {
case 1073741826:
case 1073742114:
this.getToken (++i);
...
i++;
sbCommand.append (" all");
continue ;}var min = this.floatParameter (++i);
var max = this.floatParameter (++i);
...
this.error (23);
}continue ;case 1073741873:
if (!isIsosurface) this.error (22);
toCache = !this.isSyntaxCheck;
continue ;case 1229984263:
if (this.tokAt (i + 1) != 4) this.error (23);
continue ;case 1112541195:
case 1649412112:
if (surfaceObjectSeen) sbCommand.append (" ").append (this.theToken.value);
var rd = this.encodeRadiusParameter (i, false, true);
if (surfaceObjectSeen) sbCommand.append (" ").append (rd);
...
i = this.iToken;
if (surfaceObjectSeen) sbCommand.append (" plane ").append (org.jmol.util.Escape.escape (propertyValue));
break;
case 1073742138:
propertyName = "scale";
propertyValue = Float.$valueOf (this.floatParameter (++i));
...
sbCommand.append (" lcaocartoon ").append (org.jmol.util.Escape.escape (lcaoType));
switch (this.getToken (++i).tok) {
case 10:
case 1048577:
...
case 2:
moNumber = this.intParameter (i);
if (surfaceObjectSeen) sbCommand.append (" mo ").append (moNumber);
break;
default:
if (this.isArrayParameter (i)) {
linearCombination = this.floatParameterSet (i, 2, 2147483647);
...
propertyName = "nci";
if (surfaceObjectSeen) sbCommand.append (" " + propertyName);
var tok = this.tokAt (i + 1);
...
if (surfaceObjectSeen) sbCommand.append (" /*file*/" + org.jmol.util.Escape.escape (fname));
} else if (this.tokAt (i + 1) == 1716520973) {
mepOrMlp = propertyName;
continue ;}if (!this.isSyntaxCheck) try {
...
sbCommand.append (" anisotropy").append (org.jmol.util.Escape.escape (propertyValue));
i = this.iToken;
break;
case 1073741842:
...
}var nlmZprs =  Clazz.newArray (7, 0);
...
if (surfaceObjectSeen) sbCommand.append (" atomicOrbital ").append (Math.round (nlmZprs[0])).append (" ").append (Math.round (nlmZprs[1])).append (" ").append (Math.round (nlmZprs[2])).append (" ").append (nlmZprs[3]);
if (this.tokAt (i + 1) == 135266320) {
i += 2;
...
if (surfaceObjectSeen) sbCommand.append (" points ").append (Math.round (nlmZprs[4])).append (' ').append (nlmZprs[5]).append (' ').append (Math.round (nlmZprs[6]));
...
if (pt.z == Math.round (pt.z) && pt.z > (pt.y - pt.x)) pt.z = (pt.y - pt.x) / pt.z;
propertyValue = pt;
i = this.iToken;
sbCommand.append (" increment ").append (org.jmol.util.Escape.escape (pt));
break;
default:
...
propertyValue = Integer.$valueOf (this.intParameter (++i));
if (surfaceObjectSeen) sbCommand.append (" downsample ").append (propertyValue);
break;
case 1073741930:
propertyName = "eccentricity";
propertyValue = this.getPoint4f (++i);
if (surfaceObjectSeen) sbCommand.append (" eccentricity ").append (org.jmol.util.Escape.escape (propertyValue));
i = this.iToken;
break;
case 1074790508:
sbCommand.append (" ed");
...
propertyValue = vxy;
isFxy = true;
if (surfaceObjectSeen) sbCommand.append (" ").append (propertyName);
var name = this.parameterAsString (++i);
if (name.equals ("=")) {
if (surfaceObjectSeen) sbCommand.append (" =");
name = this.parameterAsString (++i);
if (surfaceObjectSeen) sbCommand.append (" ").append (org.jmol.util.Escape.escape (name));
vxy.add (name);
...
if (!surfaceObjectSeen) sbCommand.append (" inline");
vxy.add (name);
var pt3 = this.getPoint3f (++i, false);
if (!surfaceObjectSeen) sbCommand.append (" ").append (org.jmol.util.Escape.escape (pt3));
vxy.add (pt3);
var pt4;
ptX = ++this.iToken;
vxy.add (pt4 = this.getPoint4f (ptX));
if (!surfaceObjectSeen) sbCommand.append (" ").append (org.jmol.util.Escape.escape (pt4));
nX = Math.round (pt4.x);
ptY = ++this.iToken;
...
nY = Math.abs (nY);
nZ = Math.abs (nZ);
xyzdata = this.floatArraySet (++this.iToken, nX, nY, nZ);
} else if (isXYZV) {
...
this.iToken = ptX;
this.error (53, "xyzdata[" + xyzdata.length + "][" + xyzdata[0].length + "][" + xyzdata[0][0].length + "] is not of size [" + nX + "][" + nY + "][" + nZ + "]");
}vxy.add (xyzdata);
if (!surfaceObjectSeen) sbCommand.append (" ").append (org.jmol.util.Escape.escape (xyzdata));
} else {
if (isInline) {
nX = Math.abs (nX);
nY = Math.abs (nY);
...
vxy.add (fdata);
if (!surfaceObjectSeen) sbCommand.append (" ").append (org.jmol.util.Escape.escape (fdata));
}}i = this.iToken;
break;
case 1073741970:
...
case 1073741976:
propertyName = "ignore";
propertyValue = bsIgnore = this.atomExpression (++i);
...
propertyValue = this.getPoint4f (++i);
i = this.iToken;
if (!surfaceObjectSeen) sbCommand.append (" lobe ").append (org.jmol.util.Escape.escape (propertyValue));
surfaceObjectSeen = true;
break;
case 1073742004:
case 1073742006:
...
propertyValue = this.getPoint4f (++i);
i = this.iToken;
if (!surfaceObjectSeen) sbCommand.append (" lp ").append (org.jmol.util.Escape.escape (propertyValue));
surfaceObjectSeen = true;
break;
case 1052700:
...
surfaceObjectSeen = true;
this.addShapeProperty (propertyList, "bsSolvent", (haveRadius || haveIntersection ?  new java.util.BitSet () : this.lookupIdentifierValue ("solvent")));
this.addShapeProperty (propertyList, "sasurface", Float.$valueOf (0));
}if (sbCommand.length () == 0) {
var plane = this.getShapeProperty (23, "plane");
if (plane == null) {
...
propertyValue = this.getPoint4f (++i);
i = this.iToken;
if (!surfaceObjectSeen) sbCommand.append (" radical ").append (org.jmol.util.Escape.escape (propertyValue));
break;
case 1073742028:
propertyName = "fixed";
propertyValue = Boolean.FALSE;
...
propertyName = "molecular";
if (!surfaceObjectSeen) sbCommand.append (" molecular");
radius = 1.4;
} else {
...
if (!surfaceObjectSeen) sbCommand.append (" ").append (radius);
}propertyValue = Float.$valueOf (radius);
if (this.tokAt (i + 1) == 1073741961) {
this.addShapeProperty (propertyList, "doFullMolecular", null);
if (!surfaceObjectSeen) sbCommand.append (" full");
i++;
}surfaceObjectSeen = true;
break;
case 1073742033:
this.addShapeProperty (propertyList, "fileType", "MRC");
if (!surfaceObjectSeen) sbCommand.append (" mrc");
continue ;case 1073742064:
case 1073742062:
this.addShapeProperty (propertyList, "fileType", "Obj");
if (!surfaceObjectSeen) sbCommand.append (" obj");
continue ;case 1073742034:
this.addShapeProperty (propertyList, "fileType", "Msms");
if (!surfaceObjectSeen) sbCommand.append (" msms");
continue ;case 1073742094:
if (surfaceObjectSeen) this.error (22);
propertyName = "phase";
isPhased = true;
...
propertyName = "sphere";
propertyValue = Float.$valueOf (this.floatParameter (++i));
if (!surfaceObjectSeen) sbCommand.append (" sphere ").append (propertyValue);
surfaceObjectSeen = true;
break;
case 1073742156:
propertyName = "squareData";
...
if (isPmesh) sType = org.jmol.util.TextFormat.replaceAllCharacters (sType, "{,}|", ' ');
...
if (!surfaceObjectSeen) sbCommand.append (" cutoff ").append (cutoff);
}}if (ptWithin == 0) {
onlyOneModel = "=xxxx";
...
if (!surfaceObjectSeen) sbCommand.append (" within 2.0 ").append (org.jmol.util.Escape.escape (bs));
...
if (!surfaceObjectSeen) sbCommand.append (" sigma -1.0");
...
if (modelIndex < 0) modelIndex = this.viewer.getCurrentModelIndex ();
if (surfaceObjectSeen || planeSeen) propertyValue = this.viewer.getModelAuxiliaryInfo (modelIndex, "jmolMappedDataInfo");
if (propertyValue == null) propertyValue = this.viewer.getModelAuxiliaryInfo (modelIndex, "jmolSurfaceInfo");
if (propertyValue != null) {
surfaceObjectSeen = true;
break;
...
if (fullPathNameOrError[1] != null) this.error (17, filename + ":" + fullPathNameOrError[1]);
...
if (!surfaceObjectSeen) sbCommand.append (" /*file*/").append (org.jmol.util.Escape.escape (filename));
}if (!surfaceObjectSeen) if (fileIndex >= 0) sbCommand.append (" ").append (fileIndex);
}if (!surfaceObjectSeen) if (sType != null) sbCommand.append (" ").append (org.jmol.util.Escape.escape (sType));
surfaceObjectSeen = true;
break;
case 4106:
...
case 10:
case 1048577:
propertyValue = [this.atomExpression (i).nextSetBit (0)];
break;
default:
propertyValue = [Math.round (this.floatParameterSet (i, 1, 1)[0])];
break;
}
i = this.iToken;
break;
case 1073741999:
propertyName = "link";
if (!surfaceObjectSeen) sbCommand.append (" link");
break;
default:
...
surfaceObjectSeen = true;
this.addShapeProperty (propertyList, "bsSolvent", (haveRadius ?  new java.util.BitSet () : this.lookupIdentifierValue ("solvent")));
this.addShapeProperty (propertyList, "sasurface", Float.$valueOf (0));
...
if (bsModels.cardinality () != 1) this.error (30, "ISOSURFACE " + onlyOneModel);
if (needSelect) {
...
if (Clazz.instanceOf (area, Float)) this.viewer.setFloatProperty ("isosurfaceArea", (area).floatValue ());
 else this.viewer.setUserVariable ("isosurfaceArea", org.jmol.script.ScriptVariable.getVariable (area));
}if (doCalcVolume) {
...
if (Clazz.instanceOf (volume, Float)) this.viewer.setFloatProperty ("isosurfaceVolume", (volume).floatValue ());
 else this.viewer.setUserVariable ("isosurfaceVolume", org.jmol.script.ScriptVariable.getVariable (volume));
}if (!isLcaoCartoon) {
...
var s = this.getShapeProperty (iShape, "ID");
...
if (doCalcArea) s += "\nisosurfaceArea = " + org.jmol.util.Escape.escapeArray (area);
if (doCalcVolume) s += "\nisosurfaceVolume = " + org.jmol.util.Escape.escapeArray (volume);
this.showString (s);
}} else if (doCalcArea || doCalcVolume) {
if (doCalcArea) this.showString ("isosurfaceArea = " + org.jmol.util.Escape.escapeArray (area));
if (doCalcVolume) this.showString ("isosurfaceVolume = " + org.jmol.util.Escape.escapeArray (volume));
...
this.viewer.cachePut ("isosurface_" + id, this.write ([ new org.jmol.script.Token (135180, "isosurface")]));
...
}, $fz.isPrivate = true, $fz), "java.util.List,~N,javax.vecmath.Point3f,java.util.BitSet,~B");
...
switch (tok) {
case 1073741994:
if (shape != 23) return false;
if (checkOnly) return true;
var lattice = this.getPoint3f (this.iToken + 1, false);
lattice.x = Math.round (lattice.x);
lattice.y = Math.round (lattice.y);
lattice.z = Math.round (lattice.z);
...
if (this.isSyntaxCheck) return  new java.util.BitSet ();
if (this.getShapeProperty (23, "getVertices", data)) return this.viewer.getAtomsWithin (distance, data[1], data[2]);
data[1] = Integer.$valueOf (0);
data[2] = Integer.$valueOf (-1);
if (this.getShapeProperty (22, "getCenter", data)) return this.viewer.getAtomsWithin (distance, data[2]);
return  new java.util.BitSet ();
}, "~N,~S");
c$.getFloatEncodedInt = Clazz.defineMethod (c$, "getFloatEncodedInt", 
function (strDecimal) {
var pt = strDecimal.indexOf (".");
if (pt < 1 || (strDecimal.charAt (0)).charCodeAt (0) == ('-').charCodeAt (0) || strDecimal.endsWith (".") || strDecimal.contains (".0")) return 2147483647;
var i = 0;
var j = 0;
if (pt > 0) {
try {
...
return (((Math.floor (bondOrderInteger / 1000000)) % 6) << 5) + ((bondOrderInteger % 1000000) & 0x1F);
}, "~N");
...
c$.$ScriptEvaluator$ScriptException$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
Clazz.instantialize (this, arguments);
}, org.jmol.script.ScriptEvaluator, "ScriptException", Exception);
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, org.jmol.script.ScriptEvaluator.ScriptException, []);
this.b$["org.jmol.script.ScriptEvaluator"].errorType = this.message = a;
this.b$["org.jmol.script.ScriptEvaluator"].iCommandError = this.b$["org.jmol.script.ScriptEvaluator"].pc;
this.untranslated = (b == null ? a : b);
if (this.message == null) {
this.message = "";
return ;
}var c = this.b$["org.jmol.script.ScriptEvaluator"].getScriptContext ().getContextTrace (null, true).toString ();
while (this.b$["org.jmol.script.ScriptEvaluator"].thisContext != null) this.b$["org.jmol.script.ScriptEvaluator"].popContext (false, false);

this.message += c;
this.untranslated += c;
if (this.b$["org.jmol.script.ScriptEvaluator"].isSyntaxCheck || a.indexOf ("file recognized as a script file:") >= 0) return ;
org.jmol.util.Logger.error ("eval ERROR: " + this.toString ());
if (this.b$["org.jmol.script.ScriptEvaluator"].viewer.autoExit) this.b$["org.jmol.script.ScriptEvaluator"].viewer.exitJmol ();
}, "~S,~S");
Clazz.defineMethod (c$, "getErrorMessageUntranslated", 
function () {
