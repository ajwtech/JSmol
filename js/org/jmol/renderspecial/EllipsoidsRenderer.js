...
this.factoredLengths =  Clazz.newArray (3, 0);
this.selectedPoints =  new Array (3);
this.mat =  new javax.vecmath.Matrix3f ();
this.mTemp =  new javax.vecmath.Matrix3f ();
this.mDeriv =  new javax.vecmath.Matrix4f ();
this.matScreenToCartesian =  new javax.vecmath.Matrix3f ();
this.matScreenToEllipsoid =  new javax.vecmath.Matrix3f ();
this.matEllipsoidToScreen =  new javax.vecmath.Matrix3f ();
this.coef =  Clazz.newArray (10, 0);
this.v1 =  new javax.vecmath.Vector3f ();
this.v2 =  new javax.vecmath.Vector3f ();
this.v3 =  new javax.vecmath.Vector3f ();
this.pt1 =  new javax.vecmath.Point3f ();
this.pt2 =  new javax.vecmath.Point3f ();
this.s0 =  new javax.vecmath.Point3i ();
this.s1 =  new javax.vecmath.Point3i ();
this.s2 =  new javax.vecmath.Point3i ();
this.screens =  new Array (32);
this.points =  new Array (6);
{
for (var i = 0; i < this.points.length; i++) this.points[i] =  new javax.vecmath.Point3f ();
...
if (this.ellipsoids.madset == null && !this.ellipsoids.haveEllipsoids) return ;
...
var atom = atoms[i];
if (!atom.isVisible (this.myVisibilityFlag)) continue ;if (atom.screenZ <= 1) continue ;var ellipsoid2 = atom.getEllipsoid ();
if (ellipsoid2 == null) continue ;for (var j = 0; j < ellipsoid2.length; j++) {
if (ellipsoid2[j] == null || this.ellipsoids.madset[j] == null || this.ellipsoids.madset[j][i] == 0) continue ;this.colix = org.jmol.shape.Shape.getColix (this.ellipsoids.colixset[j], i, atom);
if (!this.g3d.setColix (this.colix)) continue ;this.render1 (atom, ellipsoid2[j]);
}
}
...
if (ellipsoid.visible && ellipsoid.isValid) this.renderEllipsoid (ellipsoid);
}
}this.coords = null;
});
...
}, $fz.isPrivate = true, $fz), "javax.vecmath.Point3f,~N,~N");
