...
Clazz.load (["org.jmol.shape.Mesh", "org.jmol.jvxl.data.JvxlData"], "org.jmol.shapesurface.IsosurfaceMesh", ["java.lang.Character", "$.Float", "$.StringBuffer", "java.util.ArrayList", "$.BitSet", "$.Hashtable", "javax.vecmath.Matrix4f", "$.Point3f", "$.Point4f", "$.Vector3f", "org.jmol.api.Interface", "org.jmol.g3d.Graphics3D", "org.jmol.jvxl.data.JvxlCoder", "org.jmol.script.Token", "org.jmol.util.ArrayUtil", "$.BoxInfo", "$.ColorEncoder", "$.ColorUtil", "$.Escape", "$.Logger", "$.Measure", "$.Parser", "org.jmol.viewer.Viewer"], function () {
...
function (thisID, g3d, colix, index) {
Clazz.superConstructor (this, org.jmol.shapesurface.IsosurfaceMesh, [thisID, g3d, colix, index]);
this.checkByteCount = 2;
this.jvxlData.version = org.jmol.viewer.Viewer.getJmolVersion ();
}, "~S,org.jmol.g3d.Graphics3D,~N,~N");
...
if (this.vertexColixes != null) for (var i = this.vertexCount; --i >= 0; ) this.vertexColixes[i] = org.jmol.g3d.Graphics3D.getColixTranslucent (this.vertexColixes[i], isTranslucent, iLevel);
...
if (pi == null) continue ;var pt = this.centers[i] =  new javax.vecmath.Point3f ();
...
}this.jvxlData.contourColixes =  Clazz.newArray (n, 0);
this.jvxlData.contourValues =  Clazz.newArray (n, 0);
for (var i = 0; i < n; i++) {
...
this.jvxlData.contourColors = org.jmol.g3d.Graphics3D.getHexCodes (colixes);
...
(this.jvxlData.vContours[i].get (4))[0] = org.jmol.g3d.Graphics3D.getArgb (colix);
}
return ;
}var defaultColix = 0;
this.polygonColixes =  Clazz.newArray (this.polygonCount, 0);
for (var i = 0; i < this.polygonCount; i++) {
var pi = this.polygonIndexes[i];
if (pi == null) continue ;this.polygonColixes[i] = defaultColix;
...
colors.add (org.jmol.util.ColorUtil.colorPointFromInt2 (org.jmol.g3d.Graphics3D.getArgb (this.jvxlData.contourColixes[i])));
}
...
colix = org.jmol.g3d.Graphics3D.copyColixTranslucency (this.colix, colix);
...
if (!isAtoms) {
return ;
}var color = org.jmol.g3d.Graphics3D.getHexCode (colix);
...
this.jvxlData.color = org.jmol.g3d.Graphics3D.getHexCode (this.colix);
this.jvxlData.meshColor = (this.meshColix == 0 ? null : org.jmol.g3d.Graphics3D.getHexCode (this.meshColix));
this.jvxlData.translucency = org.jmol.g3d.Graphics3D.getColixTranslucencyFractional (this.colix);
...
this.colix = org.jmol.g3d.Graphics3D.getColix (colorRgb);
} else if (this.jvxlData.color != null) {
this.colix = org.jmol.g3d.Graphics3D.getColix (this.jvxlData.color);
}if (this.colix == 0) this.colix = 5;
this.colix = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colix, this.jvxlData.translucency != 0, this.jvxlData.translucency);
if (this.jvxlData.meshColor != null) this.meshColix = org.jmol.g3d.Graphics3D.getColix (this.jvxlData.meshColor);
...
var bsMap = entry.getValue ();
var colix = org.jmol.g3d.Graphics3D.copyColixTranslucency (this.colix, org.jmol.g3d.Graphics3D.getColix (entry.getKey ()));
...
translucentLevel = org.jmol.g3d.Graphics3D.getColixTranslucencyLevel (this.colix);
} else {
this.colix = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colix, true, translucentLevel);
}var min = ce.lo;
var max = ce.hi;
this.vertexColorMap = null;
this.polygonColixes = null;
...
if (this.vertexColixes == null || this.vertexColixes.length != this.vertexCount) this.vertexColixes =  Clazz.newArray (this.vertexCount, 0);
if (this.jvxlData.isBicolorMap) {
for (var i = this.mergeVertexCount0; i < this.vertexCount; i++) this.vertexColixes[i] = org.jmol.g3d.Graphics3D.copyColixTranslucency (this.colix, this.vertexValues[i] < 0 ? this.jvxlData.minColorIndex : this.jvxlData.maxColorIndex);
...
var isTranslucent = org.jmol.g3d.Graphics3D.isColixTranslucent (this.colix);
if (ce.isTranslucent) {
if (!isTranslucent) this.colix = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colix, true, 0.5);
isTranslucent = false;
...
color[0] = org.jmol.g3d.Graphics3D.getArgb (colix[0]);
}
}if (this.contourValues != null) {
this.contourColixes =  Clazz.newArray (this.contourValues.length, 0);
...
if (this.polygonIndexes == null) this.polygonIndexes =  Clazz.newArray (0, 0);
if (m != null && m.polygonIndexes == null) m.polygonIndexes =  Clazz.newArray (0, 0);
...
if ((p = m.polygonIndexes[i]) == null || m.bsSlabDisplay != null && !m.bsSlabDisplay.get (i)) continue ;newPolygons[ipt++] = m.polygonIndexes[i];
