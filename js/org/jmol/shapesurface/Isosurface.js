...
Clazz.load (["org.jmol.jvxl.api.MeshDataServer", "org.jmol.shape.MeshCollection", "javax.vecmath.Point3i", "$.Point4f"], "org.jmol.shapesurface.Isosurface", ["java.io.BufferedReader", "$.InputStreamReader", "java.lang.Boolean", "$.Float", "$.StringBuffer", "java.util.ArrayList", "$.BitSet", "$.Hashtable", "javax.vecmath.AxisAngle4f", "$.Matrix3f", "$.Point3f", "$.Vector3f", "org.jmol.g3d.Graphics3D", "org.jmol.jvxl.data.JvxlCoder", "$.JvxlData", "$.MeshData", "org.jmol.jvxl.readers.SurfaceGenerator", "org.jmol.shape.Mesh", "org.jmol.shapesurface.IsosurfaceMesh", "org.jmol.util.ArrayUtil", "$.ColorUtil", "$.Escape", "$.Logger", "$.Measure", "$.MeshSurface", "$.Parser", "$.Quaternion", "$.TextFormat", "org.jmol.viewer.JmolConstants", "$.Viewer"], function () {
...
this.currentMesh = this.thisMesh = this.isomeshes[index] = (m == null ?  new org.jmol.shapesurface.IsosurfaceMesh (thisID, this.g3d, this.colix, index) : m);
...
if (colix != 0) {
this.thisMesh.colorCommand = "color isosurface " + org.jmol.g3d.Graphics3D.getHexCode (colix);
this.setProperty ("color",  new Integer (org.jmol.g3d.Graphics3D.getArgb (colix)), null);
}}this.thisMesh.colorAtoms (org.jmol.g3d.Graphics3D.getColix (value), bs);
}return ;
...
if (this.thisMesh != null) {
this.thisMesh.colorVertices (org.jmol.g3d.Graphics3D.getColix (value), bs);
}return ;
}if ("colorPhase" === propertyName) {
var colors = value;
if (this.thisMesh != null) {
this.thisMesh.colorPhased = true;
this.thisMesh.colix = this.thisMesh.jvxlData.minColorIndex = org.jmol.g3d.Graphics3D.getColix ((colors[0]).intValue ());
this.thisMesh.jvxlData.maxColorIndex = org.jmol.g3d.Graphics3D.getColix ((colors[1]).intValue ());
...
this.meshColix = org.jmol.g3d.Graphics3D.getColix (rgb);
...
var rgb = (value).intValue ();
this.defaultColix = org.jmol.g3d.Graphics3D.getColix (rgb);
...
if (count != 0) list1.append (" ").append (count).append (" ").append ((colix == 0 ? 0 : org.jmol.g3d.Graphics3D.getArgb (colix)));
if (done) break;
colix = colixes[i];
count = 1;
} else {
...
if (!imesh.isColorSolid && org.jmol.g3d.Graphics3D.isColixTranslucent (imesh.colix)) org.jmol.shape.Shape.appendCmd (sb, "color " + this.myType + " " + org.jmol.shape.Shape.getTranslucentLabel (imesh.colix));
...
this.defaultColix = org.jmol.g3d.Graphics3D.getColix (this.sg.getColor (1));
var colixNeg = org.jmol.g3d.Graphics3D.getColix (this.sg.getColor (-1));
...
info.put ("color", org.jmol.util.ColorUtil.colorPointFromInt2 (org.jmol.g3d.Graphics3D.getArgb (mesh.colix)));
...
return m.visibilityFlags != 0 && (m.modelIndex < 0 || bsVisible.get (m.modelIndex)) && !org.jmol.g3d.Graphics3D.isColixTranslucent (m.colix);
