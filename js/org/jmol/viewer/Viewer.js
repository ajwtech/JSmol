...
Clazz.load (["java.lang.Enum", "org.jmol.api.JmolViewer", "org.jmol.atomdata.AtomDataServer", "java.lang.Runtime", "java.util.ArrayList", "org.jmol.atomdata.RadiusData", "org.jmol.i18n.GT", "org.jmol.util.Dimension"], "org.jmol.viewer.Viewer", ["java.io.BufferedOutputStream", "$.BufferedReader", "$.BufferedWriter", "$.File", "$.FileWriter", "$.StringReader", "java.lang.Boolean", "$.Character", "$.Double", "$.Float", "$.StringBuffer", "$.Thread", "java.util.BitSet", "$.Date", "$.Hashtable", "javax.vecmath.Point3f", "$.Point3i", "$.Vector3f", "org.jmol.adapter.smarter.SmarterJmolAdapter", "org.jmol.api.Interface", "org.jmol.constant.EnumAxesMode", "$.EnumStereoMode", "$.EnumVdw", "org.jmol.g3d.Graphics3D", "org.jmol.modelset.Group", "org.jmol.script.ParallelProcessor", "$.ScriptCompiler", "$.ScriptEvaluator", "$.ScriptVariable", "$.Token", "org.jmol.shape.Shape", "org.jmol.util.BitSetUtil", "$.CifDataReader", "$.ColorUtil", "$.Elements", "$.Escape", "$.JmolMolecule", "$.Logger", "$.Measure", "$.OutputStringBuffer", "$.Parser", "$.TextFormat", "org.jmol.viewer.ActionManager", "$.AnimationManager", "$.ColorManager", "$.DataManager", "$.FileManager", "$.JmolConstants", "$.ModelManager", "$.PropertyManager", "$.RepaintManager", "$.ScriptManager", "$.SelectionManager", "$.ShapeManager", "$.StateManager", "$.StatusManager", "$.TransformManager11", "org.jmol.viewer.binding.Binding"], function () {
...
}, "java.util.BitSet,~S,~N,javax.vecmath.Point3f,javax.vecmath.Point3f,~S,~N");
...
this.g3d =  new org.jmol.g3d.Graphics3D (this.apiPlatform);
...
this.colorManager =  new org.jmol.viewer.ColorManager (this, this.g3d);
...
this.repaintManager =  new org.jmol.viewer.RepaintManager (this, this.shapeManager);
...
Clazz.defineMethod (c$, "mustRenderFlag", 
function () {
return this.mustRender && (this.refreshing || this.creatingImage);
});
...
org.jmol.g3d.Graphics3D.setAmbientPercent (this.global.ambientPercent);
org.jmol.g3d.Graphics3D.setDiffusePercent (this.global.diffusePercent);
org.jmol.g3d.Graphics3D.setSpecular (this.global.specular);
org.jmol.g3d.Graphics3D.setSpecularPercent (this.global.specularPercent);
org.jmol.g3d.Graphics3D.setSpecularPower (-this.global.specularExponent);
org.jmol.g3d.Graphics3D.setPhongExponent (this.global.phongExponent);
org.jmol.g3d.Graphics3D.setSpecularPower (this.global.specularPower);
org.jmol.g3d.Graphics3D.setZShadePower (this.global.zShadePower);
...
if (this.modelSet.setRotationRadius (this.animationManager.currentModelIndex, angstroms)) this.global.setParameterValue ("rotationRadius", angstroms);
}, "~N,~B");
...
}, "~N,javax.vecmath.Point3f,javax.vecmath.Vector3f,~N,javax.vecmath.Matrix3f,~N,~N,~N,~N,javax.vecmath.Point3f,~N,~N,~N");
...
return bsSelected;
}, $fz.isPrivate = true, $fz), "java.util.BitSet,~B");
...
if (bsAtoms != null) {
if (xy == 0) return ;
this.repaintManager.setSelectedTranslation (bsAtoms, xyz, xy);
} else {
switch (xyz) {
case 'X':
case 'x':
...
function () {
return Math.round (this.getZoomSetting ());
});
...
this.global.setParameterValue ((i < 10 ? "spin" : "nav") + key, value);
}, "~S,~N");
...
function (x, y, z) {
this.transformManager.setNavXYZ (Math.round (x), Math.round (y), Math.round (z));
}, "~N,~N,~N");
...
this.global.setParameterValue ("colorRasmol", isRasmol);
this.global.setParameterValue ("defaultColorScheme", (isRasmol ? "rasmol" : "jmol"));
...
this.global.setParameterValue ("=color " + org.jmol.util.Elements.elementNameFromNumber (elementNumber), org.jmol.util.Escape.escapeColor (argb));
...
this.global.setParameterValue (name + "Color", org.jmol.util.Escape.escapeColor (argb));
}, "~S,~N");
...
return org.jmol.g3d.Graphics3D.getColix (argb);
}, "~N");
...
function (val) {
return org.jmol.util.ColorUtil.colorPointFromInt2 (this.g3d.getColorArgbOrGray (this.colorManager.getColixForPropertyValue (val)));
}, "~N");
...
this.shapeManager.setShapeSize (1, 2147483647, null, null);
}, "java.util.BitSet,~B,Boolean,~B");
...
function (bs) {
this.shapeManager.setShapeSize (1, 2147483647, null, bs);
}, "java.util.BitSet");
...
}, "java.util.BitSet,~B,~B,Boolean,~B");
...
return this.getAtomBitSet (this.$eval, atomExpression);
}, "~O");
...
if (name.startsWith ("cache://")) return  new java.io.BufferedReader ( new java.io.StringReader (this.cacheGet (name.substring (8))));
...
Clazz.overrideMethod (c$, "openFileAsynchronously", 
function (fileName) {
}, "~S");
...
s = org.jmol.util.TextFormat.simpleReplace (s, "$FILENAME" + (i + 1) + "$", org.jmol.util.Escape.escape (fname.$replace ('\\', '/')));
}
...
htParams.put ("loadScript", loadScript =  new StringBuffer (org.jmol.util.TextFormat.simpleReplace (loadScript.toString (), "$FILENAME$", org.jmol.util.Escape.escape (fname.$replace ('\\', '/')))));
...
return this.loadInline (strModel, '\0', isAppend, htParams);
}} else if (isString) {
...
function (strModel) {
return this.openStringInline (strModel, null, false);
}, "~S");
Clazz.defineMethod (c$, "loadInline", 
function (strModel) {
return this.loadInline (strModel, this.global.inlineNewlineChar, false, null);
}, "~S");
Clazz.defineMethod (c$, "loadInline", 
function (strModel, newLine) {
return this.loadInline (strModel, newLine, false, null);
}, "~S,~N");
Clazz.defineMethod (c$, "loadInline", 
function (strModel, isAppend) {
return this.loadInline (strModel, String.fromCharCode (0), isAppend, null);
}, "~S,~B");
Clazz.defineMethod (c$, "loadInline", 
...
this.setFileLoadStatus (org.jmol.viewer.FileManager.FileManager.EnumFileStatus.NOT_LOADED, fullPathName, null, null, errMsg);
if (this.displayLoadErrors && !isAppend && !errMsg.equals ("#CANCELED#")) this.zap (errMsg);
return errMsg;
}if (isAppend) this.clearAtomSets ();
 else if (this.getModelkitMode () && !fileName.equals ("Jmol Model Kit")) this.setModelKitMode (false);
this.setFileLoadStatus (org.jmol.viewer.FileManager.FileManager.EnumFileStatus.CREATING_MODELSET, fullPathName, fileName, null, null);
...
this.setFileLoadStatus (org.jmol.viewer.FileManager.FileManager.EnumFileStatus.CREATED, fullPathName, fileName, this.getModelSetName (), errMsg);
if (isAppend) {
this.selectAll ();
this.setTainted (true);
this.axesAreTainted = true;
...
return this.getFileAsString (pathName, 2147483647, true, false);
});
...
function (name) {
return this.getFileAsString (name, 2147483647, false, false);
}, "~S");
Clazz.defineMethod (c$, "getFileAsString", 
...
data[0] = name;
this.getFileAsString (data, nBytesMax, doSpecialLoad, allowBinary);
return data[1];
}, "~S,~N,~B,~B");
Clazz.defineMethod (c$, "getFileAsString", 
function (data, nBytesMax, doSpecialLoad) {
return this.getFileAsString (data, nBytesMax, doSpecialLoad, true);
}, "~A,~N,~B");
Clazz.defineMethod (c$, "getFileAsString", 
...
if (bsSelected == null) bsSelected = this.getSelectionSet (false);
if (envelopeRadius == 3.4028235E38 || envelopeRadius == -1) this.addStateScript ("calculate surfaceDistance " + (envelopeRadius == 3.4028235E38 ? "FROM" : "WITHIN"), null, bsSelected, null, "", false, true);
...
}, "org.jmol.api.AtomIndexIterator,~N,javax.vecmath.Point3f,~N");
...
return this.addStateScript (script, null, null, null, null, addFrameNumber, postDefinitions);
}, "~S,~B,~B");
Clazz.defineMethod (c$, "addStateScript", 
...
}, "~S,java.util.BitSet,java.util.BitSet,java.util.BitSet,~S,~B,~B");
...
if (notify) this.setFileLoadStatus (org.jmol.viewer.FileManager.FileManager.EnumFileStatus.ZAPPED, null, (resetUndo ? "resetUndo" : this.getZapName ()), null, null);
...
}, "~N,javax.vecmath.Vector3f,javax.vecmath.Vector3f,~S");
Clazz.defineMethod (c$, "getMoleculeBitSet", 
function (atomIndex) {
return this.modelSet.getMoleculeBitSet (atomIndex);
}, "~N");
...
Clazz.defineMethod (c$, "getModelUndeletedAtomsBitSet", 
function (bsModels) {
var bs = this.modelSet.getModelAtomBitSetIncludingDeleted (bsModels);
this.excludeAtoms (bs, false);
return bs;
}, "java.util.BitSet");
...
function () {
return Math.floor (this.dimScreen.width / 2);
});
Clazz.defineMethod (c$, "getBoundBoxCenterY", 
function () {
return Math.floor (this.dimScreen.height / 2);
});
...
}, "~S,~N,javax.vecmath.Point3f,javax.vecmath.Point3f,~B");
...
function (x, y) {
return this.findNearestAtomIndex (x, y, false);
}, "~N,~N");
Clazz.defineMethod (c$, "findNearestAtomIndex", 
...
this.shapeManager.getShapeProperty (23, "unitCell", data);
...
return this.modelSet.getAtomsWithin (distance, points, bsInclude);
...
return this.modelSet.getAtomsWithin (distance, bs, withinAllModels, rd);
}, "~N,java.util.BitSet,~B,org.jmol.atomdata.RadiusData");
...
if (atomIndex < 0 || atomIndex >= this.getAtomCount ()) return  new java.util.BitSet ();
...
return org.jmol.util.CifDataReader.readCifData ( new java.io.BufferedReader ( new java.io.StringReader (data)));
}, "~N");
...
org.jmol.viewer.StateManager.appendCmd (s, "# fullName = " + org.jmol.util.Escape.escape (this.fullName));
org.jmol.viewer.StateManager.appendCmd (s, "# documentBase = " + org.jmol.util.Escape.escape (this.appletDocumentBase));
org.jmol.viewer.StateManager.appendCmd (s, "# codeBase = " + org.jmol.util.Escape.escape (this.appletCodeBase));
s.append ("\n");
...
Clazz.defineMethod (c$, "setCurrentColorRange", 
function (data, bs) {
this.colorManager.setPropertyColorRange (data, bs, this.global.propertyColorScheme);
}, "~A,java.util.BitSet");
Clazz.defineMethod (c$, "setCurrentColorRange", 
function (min, max) {
...
}, "java.util.BitSet,java.util.BitSet,~B");
...
function (i) {
var str = "" + this.getShapeProperty (6, "stringValue", i);
return str;
}, "~N");
...
function (i) {
var List = this.getShapeProperty (6, "countPlusIndices", i);
return List;
}, "~N");
...
function () {
this.global.setParameterValue ("_firstFrame", this.getModelNumberDotted (this.animationManager.firstModelIndex));
this.global.setParameterValue ("_lastFrame", this.getModelNumberDotted (this.animationManager.lastModelIndex));
this.global.setParameterValue ("_animTimeSec", this.animationManager.getAnimRunTimeSeconds ());
});
...
if (this.isStereoDouble ()) width = Math.floor ((width + 1) / 2);
...
this.imageFontScaling = (isReset || width <= 0 ? 1 : Math.floor ((this.global.zoomLarge == (height > width) ? height : width) / this.getScreenDim ())) * (this.antialiasDisplay ? 2 : 1);
if (width > 0) {
...
if (this.$noGraphicsAllowed) return null;
var fName = null;
if (fileName != null) {
...
var data = this.repaintManager.renderExport (type, this.g3d, this.modelSet, fName);
...
this.renderScreenImage (g, null, width, height);
}, "~O,~N,~N");
...
if (Clazz.instanceOf (npe, NullPointerException)) {
org.jmol.util.Logger.error ("Sun!! ... fix graphics your bugs!");
} else {
throw npe;
}
}
...
Clazz.defineMethod (c$, "getImageAs", 
function (type, quality, width, height, fileName, os) {
return this.getImageAs (type, quality, width, height, fileName, null, os, "");
...
if (ptWait >= 0) {
return this.evalStringWaitStatus ("String", strFilename.substring (0, ptWait), "", true, false, false);
...
if (this.scriptEditorVisible) this.scriptStatus ("", "paused -- type RESUME to continue", 0, null);
return true;
...
var str = this.evalStringWaitStatus ("JSON", strScript, "+scriptStarted,+scriptStatus,+scriptEcho,+scriptTerminated", false, false, false);
...
var doTranslateTemp = org.jmol.i18n.GT.getDoTranslate ();
org.jmol.i18n.GT.setDoTranslate (false);
var ret = this.evalStringWaitStatus ("object", strScript, statusList, false, false, false);
org.jmol.i18n.GT.setDoTranslate (doTranslateTemp);
return ret;
}, "~S,~S");
...
this.setStringProperty ("pathForAllFiles", 545259570, "");
});
...
return org.jmol.util.TextFormat.formatString (format, "FILE", f);
case '$':
if (f.startsWith ("$")) {
f = f.substring (1);
format = org.jmol.util.TextFormat.simpleReplace (this.global.smilesUrlFormat, "&get3d=True", "");
return org.jmol.util.TextFormat.formatString (format, "FILE", org.jmol.util.Escape.escapeUrl (f));
}case 'N':
case '2':
case 'I':
case 'K':
...
return (withPrefix ? "MOL3D::" : "") + org.jmol.util.TextFormat.formatString (format, "FILE", f);
case '_':
...
return points;
}, "java.util.BitSet,~B,~B,java.util.List");
...
if (modelIndex != this.modelSet.getModelCount () - 1) return  new java.util.BitSet ();
...
this.loadInline (sb.toString (), '\n', true, null);
this.$eval.runScript (sbConnect.toString (), null);
var bsB = this.getModelUndeletedAtomsBitSet (modelIndex);
bsB.andNot (bsA);
return bsB;
}, $fz.isPrivate = true, $fz), "java.util.BitSet,java.util.List,~A");
...
if (this.isAtomAssignable (atomIndex)) this.highlight (org.jmol.util.BitSetUtil.setBit (atomIndex));
...
function (object) {
return org.jmol.g3d.Graphics3D.getColix (object);
}, "~O");
...
this.global.setParameterValue ("pickingStyle", org.jmol.viewer.ActionManager.getPickingStyleName (this.actionManager.getPickingStyle ()));
}, "~S,~N");
...
return (atomOrPointIndex >= 0 ? this.modelSet.getAtomInfo (atomOrPointIndex, null) : this.shapeManager.getShapeProperty (6, "pointInfo", -atomOrPointIndex));
}, "~N");
...
if (Math.floor (firstNo / 1000000) == Math.floor (lastNo / 1000000)) fileNo = firstNo;
} else {
strModelNo = this.getModelNumberDotted (modelIndex);
}if (fileNo != 0) fileNo = (fileNo < 1000000 ? 1 : Math.floor (fileNo / 1000000));
...
this.global.setParameterValue ("_errormessage", errMsgUntranslated);
...
function (id, info, pt) {
this.global.setParameterValue ("_objecthovered", id);
...
this.global.setParameterValue ("_loadPoint", ptLoad.getCode ());
var doCallback = (ptLoad !== org.jmol.viewer.FileManager.FileManager.EnumFileStatus.CREATING_MODELSET);
...
}, $fz.isPrivate = true, $fz), "org.jmol.viewer.FileManager.EnumFileStatus,~S,~S,~S,~S");
...
case 603979776:
this.setBooleanProperty (key, tok, org.jmol.script.ScriptVariable.bValue (org.jmol.script.ScriptVariable.getVariable (value)));
break;
case 553648128:
...
this.global.setUserVariable (key,  new org.jmol.script.ScriptVariable (4, value));
return ;
}break;
}
this.global.setParameterValue (key, value);
...
break;
case 603979776:
this.setBooleanProperty (key, tok, value != 0);
break;
case 553648128:
this.setIntProperty (key, tok, Math.round (value));
break;
default:
this.setFloatProperty (key, tok, value);
}
}, "~S,~N");
Clazz.defineMethod (c$, "setFloatProperty", 
($fz = function (key, tok, value) {
...
break;
case 570425376:
this.setSpin ("X", Math.round (value));
break;
case 570425378:
this.setSpin ("Y", Math.round (value));
break;
case 570425380:
this.setSpin ("Z", Math.round (value));
break;
case 570425370:
if (Float.isNaN (value)) return ;
this.setSpin ("FPS", Math.round (value));
break;
case 570425363:
...
return ;
case 570425362:
this.global.hoverDelayMs = Math.round ((value * 1000));
break;
case 570425392:
...
default:
if (!this.global.htNonbooleanParameterValues.containsKey (key.toLowerCase ())) {
this.global.setUserVariable (key,  new org.jmol.script.ScriptVariable (3,  new Float (value)));
return ;
}}
this.global.setParameterValue (key, value);
...
break;
default:
this.setIntProperty (key, tok, value);
}
}, "~S,~N");
Clazz.defineMethod (c$, "setIntProperty", 
($fz = function (key, tok, value) {
...
org.jmol.g3d.Graphics3D.setPhongExponent (value);
break;
case 553648146:
...
org.jmol.g3d.Graphics3D.setSpecularPower (value);
break;
case 553648172:
...
return ;
case 536870924:
this.setBooleanProperty (key, tok, value == 1);
return ;
case 553648174:
value = org.jmol.viewer.Viewer.checkIntRange (value, 0, 100);
org.jmol.g3d.Graphics3D.setSpecularPercent (value);
break;
case 553648142:
value = org.jmol.viewer.Viewer.checkIntRange (value, 0, 100);
org.jmol.g3d.Graphics3D.setDiffusePercent (value);
break;
case 553648130:
value = org.jmol.viewer.Viewer.checkIntRange (value, 0, 100);
org.jmol.g3d.Graphics3D.setAmbientPercent (value);
break;
case 553648186:
...
break;
case 553648190:
org.jmol.g3d.Graphics3D.setZShadePower (Math.max (value, 1));
break;
case 553648166:
...
this.global.setUserVariable (key, org.jmol.script.ScriptVariable.intVariable (value));
return ;
}}
this.global.setParameterValue (key, value);
}, $fz.isPrivate = true, $fz), "~S,~N,~N");
...
break;
case 553648128:
this.setIntProperty (key, tok, value ? 1 : 0);
break;
case 570425344:
this.setFloatProperty (key, tok, value ? 1 : 0);
break;
default:
this.setBooleanProperty (key, tok, value);
}
}, "~S,~B");
Clazz.defineMethod (c$, "setBooleanProperty", 
($fz = function (key, tok, value) {
...
break;
case 536870922:
this.setIntProperty ("showScript", tok, value ? 1 : 0);
return ;
case 603979778:
...
break;
case 536870924:
org.jmol.g3d.Graphics3D.setSpecular (value);
break;
case 603979942:
...
break;
case 603979850:
this.g3d.setGreyscaleMode (this.global.greyscaleRendering = value);
break;
case 603979878:
...
return ;
case 603979822:
this.setStringProperty ("defaultcolorscheme", 545259545, value ? "rasmol" : "jmol");
return ;
case 603979824:
...
function (s) {
if (s == null) this.global.removeJmolParameter ("_smilesString");
 else this.global.setParameterValue ("_smilesString", s);
}, "~S");
...
if (this.isScriptQueued && (!this.isSilent || isPrint)) org.jmol.util.Logger.info (str);
this.scriptEcho (str);
}, "~S,~B");
...
this.global.setParameterValue ("axesMode", this.global.axesMode.getCode ());
...
Clazz.defineMethod (c$, "getCartoonRocketFlag", 
function () {
return this.global.cartoonRockets;
});
Clazz.defineMethod (c$, "getRocketBarrelFlag", 
function () {
return this.global.rocketBarrels;
});
Clazz.defineMethod (c$, "getCartoonBaseEdgesFlag", 
function () {
...
}, "~N,~N,~N,~N,java.util.BitSet,java.util.BitSet,java.util.BitSet,~B,~B,~N");
Clazz.defineMethod (c$, "rebond", 
function () {
this.rebond (false);
});
Clazz.defineMethod (c$, "rebond", 
...
this.modelSet.autoBond (null, null, null, null, this.getMadBond (), isLegacy);
...
this.clearModelDependentObjects ();
this.modelSet.deleteAllBonds ();
var bsExclude =  new java.util.BitSet ();
this.modelSet.setPdbConectBonding (0, 0, bsExclude);
if (isAuto) {
var isLegacy = isStateScript && this.checkAutoBondLegacy ();
this.modelSet.autoBond (null, null, bsExclude, null, this.getMadBond (), isLegacy);
...
function (value) {
this.global.setParameterValue ("percentVdwAtom", value);
this.global.percentVdwAtom = value;
this.rd.value = value / 100;
this.rd.factorType = org.jmol.atomdata.RadiusData.RadiusData.EnumType.FACTOR;
...
Clazz.defineMethod (c$, "getUseNumberLocalization", 
function () {
...
if (Clazz.instanceOf (v, javax.vecmath.Point3f)) v = org.jmol.util.Escape.escape (v);
...
function (i) {
return this.g3d.getColorArgbOrGray (this.modelSet.getAtomColix (i));
}, "~N");
...
function (i) {
return this.g3d.getColorArgbOrGray (this.modelSet.getBondColix1 (i));
}, "~N");
...
function (i) {
return this.g3d.getColorArgbOrGray (this.modelSet.getBondColix2 (i));
}, "~N");
...
if (twoColors != null) this.transformManager.setStereoMode (twoColors);
...
Clazz.defineMethod (c$, "getGraphics3D", 
function () {
return this.g3d;
});
...
return this.getProperty (returnType, infoType, paramInfo);
}, "~S,~S,~S");
...
scriptEditor.output (org.jmol.script.ScriptCompiler.getEmbeddedScript (msg));
...
this.global.setParameterValue ("_mouseX", x);
this.global.setParameterValue ("_mouseY", this.dimScreen.height - y);
this.global.setParameterValue ("_mouseAction", action);
this.global.setParameterValue ("_mouseModifiers", modifiers);
this.global.setParameterValue ("_clickCount", clickCount);
...
}, "javax.vecmath.Point3f,javax.vecmath.Point3f,~N,~N,~B,java.util.BitSet,javax.vecmath.Vector3f,java.util.List");
...
this.global.setParameterValue ("defaultLattice", org.jmol.util.Escape.escape (ptLattice));
}, "javax.vecmath.Point3f");
...
}, "java.util.BitSet,~N,~B");
Clazz.defineMethod (c$, "evaluateExpression", 
function (stringOrTokens) {
return org.jmol.script.ScriptEvaluator.evaluateExpression (this, stringOrTokens);
}, "~O");
...
}, "java.util.BitSet,org.jmol.util.OutputStringBuffer");
...
this.modelSet.setFrameTitle (org.jmol.util.BitSetUtil.setBit (modelIndex), title);
}, "~N,~S");
Clazz.defineMethod (c$, "setFrameTitle", 
function (title) {
this.loadShape (29);
...
this.checkMinimization ();
this.statusManager.setStatusAtomMoved (bs);
}, "javax.vecmath.Point3f,java.util.BitSet");
Clazz.defineMethod (c$, "invertAtomCoord", 
function (plane, bs) {
this.modelSet.invertSelected (null, plane, -1, null, bs);
this.checkMinimization ();
this.statusManager.setStatusAtomMoved (bs);
}, "javax.vecmath.Point4f,java.util.BitSet");
...
this.checkMinimization ();
this.statusManager.setStatusAtomMoved (bs);
}, "javax.vecmath.Point3f,javax.vecmath.Point4f,~N,java.util.BitSet");
...
}, "javax.vecmath.Matrix3f,javax.vecmath.Matrix3f,javax.vecmath.Vector3f,javax.vecmath.Point3f,~B,java.util.BitSet");
...
var ptScreen = this.transformPoint (ptCenter);
var ptScreenNew;
...
this.movingSelected = false;
}, "~N,~N,~N,~N,~N,java.util.BitSet,~B,~B");
...
bs = org.jmol.util.BitSetUtil.setBit (i);
...
atom1 = b.getAtom1 ();
atom2 = b.getAtom2 ();
this.undoMoveAction (atom1.index, 2, true);
...
atom1 = atom2;
atom2 = a;
}if (org.jmol.util.Measure.computeAngle (pt, atom1, atom2, true) > 90 || org.jmol.util.Measure.computeAngle (pt, atom2, atom1, true) > 90) {
...
data = "";
}fdata =  Clazz.newArray (nX, nY, 0);
var f =  Clazz.newArray (nX * nY, 0);
...
data = "";
}xyzdata =  Clazz.newArray (nX, nY, nZ, 0);
var f =  Clazz.newArray (nX * nY * nZ, 0);
org.jmol.util.Parser.parseStringInfestedFloatArray (data, null, f);
...
if (bsFrames == null && nVibes == 0) return this.createImage (fileName, type, text_or_bytes, scripts, quality, width, height, fullPath, true);
var info = "";
var n = 0;
...
return info + "\n" + n + " files created";
}, "~S,~S,~O,~A,~N,~N,~N,java.util.BitSet,~N,~A");
...
if (fullPath != null) fullPath[0] = fileName;
var msg = this.createImage (fileName, type, text_or_bytes, null, quality, width, height, null, false);
this.scriptEcho (msg);
...
return this.createImage (fileName, type, stateInfo, scripts, -2147483648, -1, -1, null, true);
}, "~S,~S,~S,~A");
Clazz.defineMethod (c$, "createImage", 
function (fileName, type, text_or_bytes, quality, width, height) {
return this.createImage (fileName, type, text_or_bytes, null, quality, width, height, null, true);
}, "~S,~S,~O,~N,~N,~N");
Clazz.defineMethod (c$, "createImage", 
...
if (Clazz.instanceOf (er, Throwable)) {
er.printStackTrace ();
...
script = (modelIndex == -1 && filename != null ? script = "load " + org.jmol.util.Escape.escape (filename) : "");
if (id != null) script += ";model " + org.jmol.util.Escape.escape (id);
...
var potentials =  Clazz.newArray (this.getAtomCount (), 0);
...
this.global.setParameterValue ("defaultVDW", this.getDefaultVdwTypeNameOrData (-2147483648, null));
}, "~S");
...
this.animationManager.clear ();
this.animationManager.initializePointers (1);
this.setCurrentModelIndex (this.getModelCount () > 1 ? -1 : 0, this.getModelCount () > 1);
this.hoverAtomIndex = -1;
this.setFileLoadStatus (org.jmol.viewer.FileManager.FileManager.EnumFileStatus.DELETED, null, null, null, null);
this.refreshMeasures (true);
...
return org.jmol.viewer.JmolConstants.getShapeClassName (this.currentShapeID) + " " + this.currentShapeState;
});
Clazz.defineMethod (c$, "handleError", 
function (er, doClear) {
try {
if (doClear) this.zap ("" + er);
this.undoClear ();
...
if (Clazz.instanceOf (e1, Throwable)) {
try {
org.jmol.util.Logger.error ("Could not notify error " + er + ": due to " + e1);
} catch (er2) {
if (Clazz.instanceOf (er2, Throwable)) {
} else {
throw er2;
}
}
...
}, "~N,javax.vecmath.Point4f,~N,~N");
Clazz.defineMethod (c$, "repaint", 
function () {
if (this.haveDisplay) this.apiPlatform.repaint (this.$display);
});
...
var ret = this.createImage (localName, "OutputStream", null, null, -2147483648, 0, 0, fullPath, true);
...
var bsInFrame = this.getModelUndeletedAtomsBitSet (this.getVisibleFramesBitSet ());
...
var bsNearby = this.getAtomsWithin (rangeFixed, bsSelected, true, null);
...
}, "~N,~N,java.util.BitSet,java.util.BitSet,~N,~B,~B,~B");
...
this.modelSet.getAtomicPropertyState (commands, type, bs, name, data);
...
if (bs == null) bs = this.getSelectionSet (false);
this.loadShape (5);
this.shapeManager.setShapeProperty (5, "toggleLabel", null, bs);
}, "java.util.BitSet");
...
if (bsSelected == null) bsSelected = this.getSelectionSet (false);
this.shapeManager.setShapeSize (shapeID, mad, null, bsSelected);
}, "~N,~N,java.util.BitSet");
Clazz.defineMethod (c$, "setShapeSize", 
function (shapeID, rd, bsAtoms) {
this.shapeManager.setShapeSize (shapeID, 0, rd, bsAtoms);
}, "~N,org.jmol.atomdata.RadiusData,java.util.BitSet");
Clazz.defineMethod (c$, "setShapeProperty", 
function (shapeID, propertyName, value) {
if (shapeID < 0) return ;
this.shapeManager.setShapeProperty (shapeID, propertyName, value, null);
}, "~N,~S,~O");
...
for (var i = 0; i < n; i++) this.undoMoveAction (0, action, true);
...
var bs = org.jmol.util.BitSetUtil.setBit (atomIndex);
var pts = [pt];
var vConnections =  new java.util.ArrayList ();
...
this.modelSet.setAtomNamesAndNumbers (atomIndex, -1, null);
}, "~N,javax.vecmath.Point3f,~S");
Clazz.defineMethod (c$, "assignConnect", 
function (index, index2) {
this.clearModelDependentObjects ();
var connections =  Clazz.newArray (1, 0);
...
if (bsAtoms == null) {
var atom = this.modelSet.atoms[atomIndex];
bsAtoms = org.jmol.util.BitSetUtil.setBit (atomIndex);
...
}bsSelected =  new java.util.BitSet ();
...
function (g3dExport, type, output) {
return g3dExport.initializeExporter (type, this, this.privateKey, this.g3d, output);
}, "org.jmol.api.JmolRendererInterface,~S,~O");
...
}, "java.util.BitSet,org.jmol.util.BoxInfo");
...
function (bsSelected) {
if (bsSelected == null || bsSelected.cardinality () == 0) bsSelected = this.getModelUndeletedAtomsBitSet (this.getVisibleFramesBitSet ());
...
Clazz.overrideMethod (c$, "cacheGet", 
function (key) {
return null;
}, "~S");
...
c$.$Viewer$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareType (org.jmol.viewer, "Viewer", Enum);
...
c$.nProcessors = c$.prototype.nProcessors = Runtime.getRuntime ().availableProcessors ();
Clazz.defineStatics (c$,
"MAX_ACTION_UNDO", 100);
});
