...
Clazz.load (["java.util.Hashtable", "javax.vecmath.Vector3f", "org.jmol.util.Elements"], "org.jmol.viewer.JmolConstants", ["java.io.BufferedInputStream", "java.lang.NullPointerException", "$.StringBuffer", "java.util.Properties", "org.jmol.util.Logger", "$.Parser"], function () {
...
return "org.jmol." + "shape" + (shapeID >= 9 && shapeID < 16 ? "bio." : shapeID >= 16 && shapeID < 23 ? "special." : shapeID >= 23 && shapeID < 29 ? "surface." : ".") + org.jmol.viewer.JmolConstants.shapeClassBases[shapeID];
}, "~N");
