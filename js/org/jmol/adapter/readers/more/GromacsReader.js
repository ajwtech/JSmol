...
Clazz.load (["org.jmol.adapter.smarter.AtomSetCollectionReader"], "org.jmol.adapter.readers.more.GromacsReader", ["java.lang.Float", "javax.vecmath.Point3f", "org.jmol.adapter.smarter.Atom", "org.jmol.api.JmolAdapter", "org.jmol.util.Logger"], function () {
...
($fz = function () {
var modelAtomCount = this.parseInt (this.readLine ());
...
continue ;}var atom =  new org.jmol.adapter.smarter.Atom ();
...
atom.x = this.parseFloat (this.line, 20, 28) * 10;
atom.y = this.parseFloat (this.line, 28, 36) * 10;
atom.z = this.parseFloat (this.line, 36, 44) * 10;
if (Float.isNaN (atom.x) || Float.isNaN (atom.y) || Float.isNaN (atom.z)) {
org.jmol.util.Logger.warn ("line cannot be read for GROMACS atom data: " + this.line);
atom.set (0, 0, 0);
}this.setAtomCoord (atom);
atom.elementSymbol = this.deduceElementSymbol (atom.group3, atom.atomName);
if (!this.filterAtom (atom, i)) continue ;atom.isHetero = false;
this.atomSetCollection.addAtom (atom);
if (len < 69) continue ;var vx = this.parseFloat (this.line, 44, 52) * 10;
var vy = this.parseFloat (this.line, 52, 60) * 10;
var vz = this.parseFloat (this.line, 60, 68) * 10;
...
if (org.jmol.adapter.smarter.Atom.isValidElementSymbolNoCaseSecondChar (ch1, ch2)) return (isHetero || (ch1).charCodeAt (0) != ('H').charCodeAt (0) ? "" + ch1 + ch2 : "H");
...
var a = 10 * this.parseFloat (tokens[0]);
var b = 10 * this.parseFloat (tokens[1]);
var c = 10 * this.parseFloat (tokens[2]);
