...
public class GenericImageCreator implements JmolImageCreatorInterface {
  ...
  public Object createImage(String fileName, String type, String text,
                            Object bytes_or_image, String[] scripts, int quality) {
    ...
    try {
      ...
      if (isBytes) {
        if (bytes_or_image instanceof byte[]) {
          ...
          getImageBytes(type, quality, fileName, scripts, bytes_or_image,
              null);
          return fileName;
        }
      } else if (isText) {
  ...
  public Object getImageBytes(String type, int quality, String fileName,
                              String[] scripts, Object objImage, OutputStream os)
      throws IOException {
    byte[] bytes = null;
    String errMsg = null;
    ...
    try {
      if (image == null) {
        ...
        Object ret = null;
        boolean includeState = (type.equals("PNGJ") || !asBytes);
