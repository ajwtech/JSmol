/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2011-10-16 09:58:27 -0500 (Sun, 16 Oct 2011) $
 * $Revision: 16359 $
 *
...
public abstract class ShapeRenderer {
  ...
  public void render(Graphics3D g3d, ModelSet modelSet, Shape shape) {
    this.g3d = g3d;
    this.modelSet = modelSet;
    this.shape = shape;
    exportType = Graphics3D.EXPORT_NOT;// g3d.getExportType();
    isExport = false;//(exportType != Graphics3D.EXPORT_NOT);
    render();
