...
}, javax.util, "BitSet", null, Cloneable);
...
($fz = function (nbits) {
this.words =  Clazz.newArray (javax.util.BitSet.wordIndex (nbits - 1) + 1, 0);
}, $fz.isPrivate = true, $fz), "~N");
...
var wordIndex = javax.util.BitSet.wordIndex (bitIndex);
...
var startWordIndex = javax.util.BitSet.wordIndex (fromIndex);
var endWordIndex = javax.util.BitSet.wordIndex (toIndex - 1);
...
var u = javax.util.BitSet.wordIndex (fromIndex);
...
function (obj) {
if (!(Clazz.instanceOf (obj, javax.util.BitSet))) return false;
...
try {
var result = Clazz.superCall (this, javax.util.BitSet, "clone", []);
...
if (wordCount == 0) bs.words = javax.util.BitSet.emptyBitmap;
 else {
bs.words =  Clazz.newArray (wordCount, 0);
