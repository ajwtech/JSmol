...
Clazz.load (null, "javax.vecmath.Tuple2f", ["java.lang.Float", "$.InternalError", "javax.vecmath.VecMathUtil"], function () {
c$ = Clazz.decorateAsClass (function () {
this.x = 0;
this.y = 0;
Clazz.instantialize (this, arguments);
}, javax.vecmath, "Tuple2f", null, [java.io.Serializable, Cloneable]);
...
this.x = t1.x + t2.x;
this.y = t1.y + t2.y;
}, "javax.vecmath.Tuple2f,javax.vecmath.Tuple2f");
Clazz.defineMethod (c$, "add", 
function (t1) {
this.x += t1.x;
this.y += t1.y;
...
this.x = s * t1.x + t2.x;
this.y = s * t1.y + t2.y;
}, "~N,javax.vecmath.Tuple2f,javax.vecmath.Tuple2f");
Clazz.defineMethod (c$, "scaleAdd", 
function (s, t1) {
...
}, "javax.vecmath.Tuple2f,javax.vecmath.Tuple2f,~N");
Clazz.defineMethod (c$, "interpolate", 
function (t1, alpha) {
...
function () {
try {
return Clazz.superCall (this, javax.vecmath.Tuple2f, "clone", []);
} catch (e) {
