...
Clazz.load (["javax.vecmath.Tuple4f"], "javax.vecmath.Quat4f", null, function () {
c$ = Clazz.declareType (javax.vecmath, "Quat4f", javax.vecmath.Tuple4f, java.io.Serializable);
Clazz.makeConstructor (c$, 
function (x, y, z, w) {
Clazz.superConstructor (this, javax.vecmath.Quat4f, []);
var mag;
...
this.x = x;
this.y = y;
}}, "javax.vecmath.Quat4f,javax.vecmath.Quat4f");
Clazz.defineMethod (c$, "mul", 
function (q1) {
var x;
var y;
...
function (q1, q2) {
var tempQuat =  new javax.vecmath.Quat4f (q2);
tempQuat.inverse ();
this.mul (q1, tempQuat);
}, "javax.vecmath.Quat4f,javax.vecmath.Quat4f");
Clazz.defineMethod (c$, "mulInverse", 
function (q1) {
var tempQuat =  new javax.vecmath.Quat4f (q1);
tempQuat.inverse ();
this.mul (tempQuat);
}, "javax.vecmath.Quat4f");
...
var mag;
var amag;
amag = (1.0 / Math.sqrt (a.x * a.x + a.y * a.y + a.z * a.z));
if (amag < 1.0E-6) {
this.w = 0.0;
this.x = 0.0;
this.y = 0.0;
...
}, "javax.vecmath.Quat4f,javax.vecmath.Quat4f,~N");
