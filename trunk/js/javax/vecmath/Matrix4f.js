...
Clazz.load (null, "javax.vecmath.Matrix4f", ["java.lang.ArrayIndexOutOfBoundsException", "$.InternalError", "$.RuntimeException", "javax.vecmath.Matrix3d", "$.SingularMatrixException", "$.VecMathI18N", "$.VecMathUtil"], function () {
...
}, javax.vecmath, "Matrix4f", null, [java.io.Serializable, Cloneable]);
...
break;
default:
throw  new ArrayIndexOutOfBoundsException (javax.vecmath.VecMathI18N.getString ("Matrix4f0"));
}
break;
case 1:
switch (column) {
...
throw  new ArrayIndexOutOfBoundsException (javax.vecmath.VecMathI18N.getString ("Matrix4f1"));
}, "~N,~N");
...
throw  new ArrayIndexOutOfBoundsException (javax.vecmath.VecMathI18N.getString ("Matrix4f2"));
}}, "~N,javax.vecmath.Vector4f");
Clazz.defineMethod (c$, "getRow", 
function (row, v) {
if (row == 0) {
v[0] = this.m00;
...
throw  new ArrayIndexOutOfBoundsException (javax.vecmath.VecMathI18N.getString ("Matrix4f4"));
}}, "~N,javax.vecmath.Vector4f");
Clazz.defineMethod (c$, "getColumn", 
function (column, v) {
if (column == 0) {
...
break;
default:
throw  new ArrayIndexOutOfBoundsException (javax.vecmath.VecMathI18N.getString ("Matrix4f6"));
}
}, "~N,~N,~N,~N,~N");
Clazz.defineMethod (c$, "setRow", 
function (row, v) {
...
break;
default:
throw  new ArrayIndexOutOfBoundsException (javax.vecmath.VecMathI18N.getString ("Matrix4f9"));
}
}, "~N,~N,~N,~N,~N");
Clazz.defineMethod (c$, "setColumn", 
function (column, v) {
...
throw  new javax.vecmath.SingularMatrixException (javax.vecmath.VecMathI18N.getString ("Matrix4f12"));
...
if (imax < 0) {
throw  new RuntimeException (javax.vecmath.VecMathI18N.getString ("Matrix4f13"));
}if (j != imax) {
k = 4;
p1 = mtx + (4 * imax);
p2 = mtx + (4 * j);
