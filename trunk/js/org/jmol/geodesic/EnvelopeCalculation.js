...
Clazz.load (["java.util.BitSet", "javax.vecmath.Point3f", "org.jmol.atomdata.AtomData"], "org.jmol.geodesic.EnvelopeCalculation", ["javax.vecmath.Vector3f", "org.jmol.atomdata.RadiusData", "org.jmol.util.ArrayUtil", "$.BitSetUtil", "$.Geodesic", "$.Normix"], function () {
...
this.emptySet =  new java.util.BitSet ();
...
this.geodesicMap = org.jmol.geodesic.EnvelopeCalculation.allocateBitmap (this.geodesicCount);
this.mapT = org.jmol.geodesic.EnvelopeCalculation.allocateBitmap (this.geodesicCount);
}, "org.jmol.atomdata.AtomDataServer,~N,~A");
c$.allocateBitmap = Clazz.defineMethod (c$, "allocateBitmap", 
function (bitCount) {
return  new java.util.BitSet (bitCount);
}, "~N");
...
var map;
if (this.geodesicMap.isEmpty ()) map = this.emptySet;
 else map = this.newBitSet (this.geodesicMap);
...
Clazz.defineMethod (c$, "newBitSet", 
function (bitsetToCopy) {
return org.jmol.util.BitSetUtil.copy (bitsetToCopy);
}, "java.util.BitSet");
...
if (map == null || map.isEmpty ()) continue ;var bsNew =  new java.util.BitSet ();
...
}, "java.util.BitSet,javax.vecmath.Matrix3f");
...
this.bsSurface =  new java.util.BitSet ();
...
}, "org.jmol.atomdata.RadiusData,~N,java.util.BitSet,java.util.BitSet,~B,~B,~B,~B");
...
this.calculate ( new org.jmol.atomdata.RadiusData (3.0, org.jmol.atomdata.RadiusData.RadiusData.EnumType.ABSOLUTE, null), 3.4028235E38, this.bsMySelected, null, false, false, false, false);
}if (this.currentPoints != null) return this.currentPoints;
var nPoints = 0;
var dotCount = 42;
for (var i = this.dotsConvexMax; --i >= 0; ) if (this.dotsConvexMaps[i] != null) nPoints += this.cardinality (this.dotsConvexMaps[i], dotCount);
...
($fz = function (bitmap, max) {
var n = bitmap.cardinality ();
for (var i = bitmap.length (); --i >= max; ) if (bitmap.get (i)) n--;

return n;
}, $fz.isPrivate = true, $fz), "java.util.BitSet,~N");
...
this.addIncompleteFaces (this.geodesicMap);
}map = this.newBitSet (this.geodesicMap);
...
this.neighborIndices = org.jmol.util.ArrayUtil.doubleLength (this.neighborIndices);
this.neighborCenters = org.jmol.util.ArrayUtil.doubleLength (this.neighborCenters);
this.neighborPlusProbeRadii2 = org.jmol.util.ArrayUtil.doubleLength (this.neighborPlusProbeRadii2);
this.neighborRadii2 = org.jmol.util.ArrayUtil.doubleLength (this.neighborRadii2);
