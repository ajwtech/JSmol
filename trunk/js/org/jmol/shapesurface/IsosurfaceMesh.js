...
if (this.vertexColixes != null) for (var i = this.vertexCount; --i >= 0; ) this.vertexColixes[i] = org.jmol.util.Colix.getColixTranslucent (this.vertexColixes[i], isTranslucent, iLevel);
...
this.colix = org.jmol.util.Colix.getColix (this.jvxlData.color);
}if (this.colix == 0) this.colix = 5;
this.colix = org.jmol.util.Colix.getColixTranslucent (this.colix, this.jvxlData.translucency != 0, this.jvxlData.translucency);
if (this.jvxlData.meshColor != null) this.meshColix = org.jmol.util.Colix.getColix (this.jvxlData.meshColor);
...
var bsMap = entry.getValue ();
var colix = org.jmol.util.Colix.copyColixTranslucency (this.colix, org.jmol.util.Colix.getColix (entry.getKey ()));
...
this.colix = org.jmol.util.Colix.getColixTranslucent (this.colix, true, translucentLevel);
}var min = ce.lo;
var max = ce.hi;
this.vertexColorMap = null;
this.polygonColixes = null;
...
if (ce.isTranslucent) {
if (!isTranslucent) this.colix = org.jmol.util.Colix.getColixTranslucent (this.colix, true, 0.5);
isTranslucent = false;
