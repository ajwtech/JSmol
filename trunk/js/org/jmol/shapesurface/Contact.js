...
this.vZ =  new javax.vecmath.Vector3f ();
this.vY =  new javax.vecmath.Vector3f ();
this.vX =  new javax.vecmath.Vector3f ();
...
if (rd == null) rd =  new org.jmol.atomdata.RadiusData (saProbeRadius, org.jmol.atomdata.RadiusData.RadiusData.EnumType.OFFSET, org.jmol.constant.EnumVdw.AUTO);
if (colorDensity) {
switch (displayType) {
case 1073741961:
case 1276117510:
...
var intramolecularMode = Math.round ((parameters == null || parameters.length < 2 ? 0 : parameters[1]));
...
if (contactType != 0 && cp.contactType != contactType) continue ;var nV = this.thisMesh.vertexCount;
this.thisMesh.nSets++;
...
while (iter.hasNext ()) {
var ib = iter.next ();
if (isMultiModel && !bsB.get (ib)) continue ;var atomB = this.atoms[ib];
var isSameMolecule = (ad.atomMolecule[ia] == ad.atomMolecule[ib]);
if (ia == ib || isSameMolecule && atomA.isWithinFourBonds (atomB)) continue ;switch (intramolecularMode) {
case 0:
break;
case 1:
case 2:
...
if (d > ra + rb) continue ;var cp =  new org.jmol.util.ContactPair (this.atoms, ia, ib, ra, rb, vdwA, vdwB);
...
rdB =  new org.jmol.atomdata.RadiusData ((rd.factorType === org.jmol.atomdata.RadiusData.RadiusData.EnumType.OFFSET ? rd.value * 2 : (rd.value - 1) * 2 + 1), rd.factorType, rd.vdwType);
} else {
rdA = rdB = rd;
...
c$.rdVDW = c$.prototype.rdVDW =  new org.jmol.atomdata.RadiusData (1, org.jmol.atomdata.RadiusData.RadiusData.EnumType.FACTOR, org.jmol.constant.EnumVdw.AUTO);
});
