...
Clazz.load (["org.jmol.util.JmolNode", "$.Point3fi", "org.jmol.constant.EnumPalette", "org.jmol.viewer.JmolConstants"], "org.jmol.modelset.Atom", ["java.lang.Float", "$.StringBuffer", "javax.vecmath.Point3f", "$.Vector3f", "org.jmol.atomdata.RadiusData", "org.jmol.constant.EnumVdw", "org.jmol.g3d.Graphics3D", "org.jmol.util.ColorUtil", "$.Elements"], function () {
...
this.colixAtom = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colixAtom, isTranslucent, translucentLevel);
}, "~B,~N");
Clazz.defineMethod (c$, "isTranslucent", 
function () {
return org.jmol.g3d.Graphics3D.isColixTranslucent (this.colixAtom);
});
...
this.setFractionalCoord (this, ptNew, asAbsolute);
...
function (allInfo) {
var pt = (this.group.chain.model.isJmolDataFrame ? this.getFractionalCoord (false) : this);
