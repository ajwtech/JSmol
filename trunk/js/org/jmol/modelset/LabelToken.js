...
var lt = tokens[i];
if (lt == null) break;
if (lt.key == null) continue ;var value = values.get (lt.key);
...
}if (!(Clazz.instanceOf (lt.data, Array))) lt.data = null;
}lt.tok = (lt.data == null ? 4 : 135270407);
...
case 135270407:
if (t.data != null) {
if (Clazz.instanceOf (t.data, Array)) floatT = (t.data)[atom.index];
 else if (Clazz.instanceOf (t.data, Array)) {
var sdata = t.data;
