...
Clazz.load (["java.util.BitSet", "org.jmol.util.JmolEdge", "org.jmol.viewer.JmolConstants"], "org.jmol.modelset.Bond", ["org.jmol.g3d.Graphics3D", "org.jmol.util.BitSetUtil"], function () {
...
this.colix = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colix, isTranslucent, translucentLevel);
}, "~B,~N");
Clazz.defineMethod (c$, "isTranslucent", 
function () {
return org.jmol.g3d.Graphics3D.isColixTranslucent (this.colix);
});
...
function () {
return org.jmol.g3d.Graphics3D.getColixInherited (this.colix, this.atom1.colixAtom);
});
Clazz.defineMethod (c$, "getColix2", 
function () {
return org.jmol.g3d.Graphics3D.getColixInherited (this.colix, this.atom2.colixAtom);
});
