...
Clazz.load (["org.jmol.util.ColorEncoder"], "org.jmol.viewer.ColorManager", ["java.lang.Float", "$.StringBuffer", "org.jmol.constant.EnumPalette", "org.jmol.g3d.Graphics3D", "org.jmol.util.ArrayUtil", "$.ColorUtil", "$.Elements", "$.Logger", "org.jmol.viewer.JmolConstants"], function () {
...
}, "org.jmol.viewer.Viewer,org.jmol.g3d.Graphics3D");
...
function (argb) {
this.colixRubberband = (argb == 0 ? 0 : org.jmol.g3d.Graphics3D.getColix (argb));
}, "~N");
...
return (argb == 0 ? 10 : org.jmol.g3d.Graphics3D.getColix (argb));
...
return (argb == 0 ? 22 : org.jmol.g3d.Graphics3D.getColix (argb));
