...
Clazz.load (["java.util.Hashtable", "javax.vecmath.Matrix3f", "$.Point3f", "org.jmol.constant.EnumAxesMode", "$.EnumCallback"], "org.jmol.viewer.StateManager", ["java.lang.Boolean", "$.Float", "$.Runtime", "$.StringBuffer", "$.StringBuilder", "java.util.Arrays", "$.BitSet", "org.jmol.constant.EnumStructure", "org.jmol.g3d.Graphics3D", "org.jmol.script.ScriptVariable", "org.jmol.util.BitSetUtil", "$.Escape", "$.Logger", "$.TextFormat", "org.jmol.viewer.JmolConstants", "$.Viewer"], function () {
...
org.jmol.viewer.StateManager.appendCmd (a, "set ambientPercent " + org.jmol.g3d.Graphics3D.getAmbientPercent ());
org.jmol.viewer.StateManager.appendCmd (a, "set diffusePercent " + org.jmol.g3d.Graphics3D.getDiffusePercent ());
org.jmol.viewer.StateManager.appendCmd (a, "set specular " + org.jmol.g3d.Graphics3D.getSpecular ());
org.jmol.viewer.StateManager.appendCmd (a, "set specularPercent " + org.jmol.g3d.Graphics3D.getSpecularPercent ());
org.jmol.viewer.StateManager.appendCmd (a, "set specularPower " + org.jmol.g3d.Graphics3D.getSpecularPower ());
var b = org.jmol.g3d.Graphics3D.getSpecularExponent ();
var c = org.jmol.g3d.Graphics3D.getPhongExponent ();
...
org.jmol.viewer.StateManager.appendCmd (a, "set zShadePower " + org.jmol.g3d.Graphics3D.getZShadePower ());
return a.toString ();
});
...
a = a.toLowerCase ();
if (a.equals ("_memory")) {
var c = Runtime.getRuntime ();
var d = c.totalMemory () / 1000000;
var e = c.freeMemory () / 1000000;
var f = org.jmol.util.TextFormat.formatDecimal (d - e, 1) + "/" + org.jmol.util.TextFormat.formatDecimal (d, 1);
this.htNonbooleanParameterValues.put ("_memory", f);
