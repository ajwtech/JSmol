...
Clazz.load (null, "org.jmol.util.ColorEncoder", ["java.lang.Boolean", "$.Float", "java.util.ArrayList", "$.Hashtable", "org.jmol.constant.EnumPalette", "org.jmol.g3d.Graphics3D", "org.jmol.util.ArrayUtil", "$.ColorUtil", "$.Escape", "$.Logger", "$.TextFormat", "org.jmol.viewer.JmolConstants"], function () {
...
var colix = org.jmol.g3d.Graphics3D.getColix (this.getArgbFromPalette (val, lo, hi, palette));
if (isTranslucent) {
var f = (hi - val) / (hi - lo);
if (f > 1) f = 1;
 else if (f < 0.125) f = 0.125;
colix = org.jmol.g3d.Graphics3D.getColixTranslucent (colix, true, f);
}return colix;
}, "~N,~N,~N,~N,~B");
