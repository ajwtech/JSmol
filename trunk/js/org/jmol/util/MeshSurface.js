...
Clazz.load (null, "org.jmol.util.MeshSurface", ["java.lang.Boolean", "$.Float", "$.StringBuffer", "java.util.ArrayList", "$.BitSet", "$.Hashtable", "javax.vecmath.Point3f", "org.jmol.g3d.Graphics3D", "org.jmol.util.ArrayUtil", "$.BitSetUtil", "$.BoxInfo", "$.Escape", "$.Measure", "$.TextFormat"], function () {
...
var colix = (color == this.lastColor ? this.lastColix : (this.lastColix = org.jmol.g3d.Graphics3D.getColix (this.lastColor = color)));
...
if (this.polygonCount == 0) this.polygonIndexes =  Clazz.newArray (25, 0);
...
this.slabColix = org.jmol.g3d.Graphics3D.getColixTranslucent (org.jmol.g3d.Graphics3D.getColix (color), true, translucency);
}, "java.util.BitSet,java.util.BitSet,~S,~S,~N");
Clazz.defineMethod (c$, "getSlabColor", 
function () {
return (this.bsSlabGhost == null ? null : org.jmol.g3d.Graphics3D.getHexCode (this.slabColix));
});
Clazz.defineMethod (c$, "getSlabTranslucency", 
function () {
return (this.bsSlabGhost == null ? null : "" + org.jmol.g3d.Graphics3D.getColixTranslucencyFractional (this.slabColix));
});
...
if (org.jmol.g3d.Graphics3D.isColixColorInherited (this.slabColix)) this.slabColix = org.jmol.g3d.Graphics3D.copyColixTranslucency (this.slabColix, this.colix);
andCap = false;
this.colix = org.jmol.g3d.Graphics3D.getColixTranslucent (this.colix, false, 0);
}var sb =  new StringBuffer ();
sb.append (andCap ? " cap " : " slab ");
if (isGhost) sb.append ("translucent ").append (org.jmol.g3d.Graphics3D.getColixTranslucencyFractional (this.slabColix)).append (" ").append (org.jmol.g3d.Graphics3D.getHexCode (this.slabColix)).append (" ");
switch (slabType) {
case 1073741872:
sb.append ("brillouin");
...
if (!this.setABC (i)) continue ;var bsSlab = (this.bsSlabGhost != null && this.bsSlabGhost.get (i) ? this.bsSlabGhost : this.bsSlabDisplay);
...
var map =  Clazz.newArray (this.vertexCount, 0);
...
var pTemp =  Clazz.newArray (nPoly, 0);
nPoly = 0;
...
switch (tokType) {
case 3:
return (bs.get (Math.round (val)) ? 1 : -1);
case 32:
d = distance - val;
break;
case 64:
...
return dmin;
}, $fz.isPrivate = true, $fz), "javax.vecmath.Point3f,~A");
...
}, $fz.isPrivate = true, $fz), "javax.vecmath.Point3f,javax.vecmath.Point3f,~N,~N,~N,~N,~N,~A,~A,~N");
...
}, $fz.isPrivate = true, $fz), "javax.vecmath.Point3f,javax.vecmath.Point3f,~N,~N,~N,~N,~A,~A,~N");
