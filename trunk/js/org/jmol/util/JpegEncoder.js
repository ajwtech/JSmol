...
var yblockoffset;
var inputArray;
var dctArray1 =  Clazz.newArray (8, 8, 0);
var dctArray2 =  Clazz.newArray (8, 8, 0);
var dctArray3 =  Clazz.newArray (64, 0);
var lastDCvalue =  Clazz.newArray (JpegObj.NumberOfComponents, 0);
var MinBlockWidth;
var MinBlockHeight;
MinBlockWidth = ((Huf.ImageWidth % 8 != 0) ? Math.round ((Math.floor (Huf.ImageWidth / 8.0) + 1)) * 8 : Huf.ImageWidth);
MinBlockHeight = ((Huf.ImageHeight % 8 != 0) ? Math.round ((Math.floor (Huf.ImageHeight / 8.0) + 1)) * 8 : Huf.ImageHeight);
...
var index = 4;
oldindex = 4;
DHT1 =  Clazz.newArray (17, 0);
DHT4 =  Clazz.newArray (4, 0);
DHT4[0] = 0xFF;
DHT4[1] = 0xC4;
bytes = 0;
...
DHT2 =  Clazz.newArray (bytes, 0);
for (var j = 0; j < bytes; j++) {
DHT2[index++ - intermediateindex] = val[j];
}
DHT3 =  Clazz.newArray (index, 0);
...
this.quantum =  Clazz.newArray (2, 0);
this.divisors =  Clazz.newArray (2, 0);
this.quantum_luminance =  Clazz.newArray (64, 0);
this.DivisorsLuminance =  Clazz.newArray (64, 0);
this.quantum_chrominance =  Clazz.newArray (64, 0);
this.DivisorsChrominance =  Clazz.newArray (64, 0);
});
Clazz.makeConstructor (c$, 
function (quality) {
...
for (var j = 0; j < 64; j++) {
var temp = Math.floor ((values[j] * quality + 50) / 100);
...
function (input) {
var output =  Clazz.newArray (8, 8, 0);
var tmp0;
var tmp1;
var tmp2;
var tmp3;
...
var outputData =  Clazz.newArray (64, 0);
...
($fz = function () {
this.DC_matrix0 =  Clazz.newArray (12, 2, 0);
this.DC_matrix1 =  Clazz.newArray (12, 2, 0);
this.AC_matrix0 =  Clazz.newArray (255, 2, 0);
this.AC_matrix1 =  Clazz.newArray (255, 2, 0);
this.DC_matrix =  Clazz.newArray (2, 0);
this.AC_matrix =  Clazz.newArray (2, 0);
var p;
var l;
var i;
var lastp;
var si;
var code;
var huffsize =  Clazz.newArray (257, 0);
var huffcode =  Clazz.newArray (257, 0);
p = 0;
for (l = 1; l <= 16; l++) {
...
this.Components =  Clazz.newArray (this.NumberOfComponents, 0);
this.compWidth =  Clazz.newArray (this.NumberOfComponents, 0);
this.compHeight =  Clazz.newArray (this.NumberOfComponents, 0);
this.BlockWidth =  Clazz.newArray (this.NumberOfComponents, 0);
this.BlockHeight =  Clazz.newArray (this.NumberOfComponents, 0);
this.imageobj = image;
...
var values =  Clazz.newArray (this.imageWidth * this.imageHeight, 0);
var r;
var g;
var b;
var y;
...
for (y = 0; y < this.NumberOfComponents; y++) {
this.compWidth[y] = (Math.floor (((this.imageWidth % 8 != 0) ? (Math.round (Math.ceil (this.imageWidth / 8.0))) * 8 : this.imageWidth) / this.MaxHsampFactor)) * this.HsampFactor[y];
if (this.compWidth[y] != ((Math.floor (this.imageWidth / this.MaxHsampFactor)) * this.HsampFactor[y])) {
this.lastColumnIsDummy[y] = true;
}this.BlockWidth[y] = Math.round (Math.ceil (this.compWidth[y] / 8.0));
this.compHeight[y] = (Math.floor (((this.imageHeight % 8 != 0) ? (Math.round (Math.ceil (this.imageHeight / 8.0))) * 8 : this.imageHeight) / this.MaxVsampFactor)) * this.VsampFactor[y];
if (this.compHeight[y] != ((Math.floor (this.imageHeight / this.MaxVsampFactor)) * this.VsampFactor[y])) {
this.lastRowIsDummy[y] = true;
}this.BlockHeight[y] = Math.round (Math.ceil (this.compHeight[y] / 8.0));
}
values = apiPlatform.grabPixels (this.imageobj, this.imageWidth, this.imageHeight);
var Y =  Clazz.newArray (this.compHeight[0], this.compWidth[0], 0);
var Cr1 =  Clazz.newArray (this.compHeight[0], this.compWidth[0], 0);
var Cb1 =  Clazz.newArray (this.compHeight[0], this.compWidth[0], 0);
var index = 0;
