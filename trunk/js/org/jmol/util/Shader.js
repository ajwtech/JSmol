...
var i = Math.round ((-tx * f));
var j = Math.round ((-ty * f));
var k = Math.round ((tz * f));
...
}, "~N,~N,~N,~N,javax.vecmath.Matrix4f");
c$.createEllipsoidShades = Clazz.defineMethod (c$, "createEllipsoidShades", 
function () {
($t$ = org.jmol.util.Shader.ellipsoidShades =  Clazz.newArray (40, 40, 40, 0), org.jmol.util.Shader.prototype.ellipsoidShades = org.jmol.util.Shader.ellipsoidShades, $t$);
...
"SDIM", 40,
"maxSphereCache", 128,
"sphereShapeCache",  Clazz.newArray (128, 0),
