...
this.readLines (2);
var atomCount = 0;
while (this.readLine () != null && this.line.length >= 60 && (this.line.charAt (2)).charCodeAt (0) != 32) {
...
if (this.line.indexOf ("Charge") < 0) continue ;var tokens = this.getTokens ();
...
var lastAtom = "";
var iAtom = -1;
var sdata =  Clazz.newArray (this.moCount, 4, 0);
...
if (tokens.length == 4) {
id = tokens[0];
continue ;}if (!tokens[0].equals (lastAtom)) iAtom++;
lastAtom = tokens[0];
id = tokens[2];
...
var coefs =  Clazz.newArray (this.moCount, 0);
...
while (this.line != null && (this.line.charAt (2)).charCodeAt (0) != 32) {
...
if (ignore[i]) continue ;this.atomSetCollection.cloneFirstAtomSet (0);
