...
Clazz.load (["javax.vecmath.Point3f", "$.Vector3f"], "org.jmol.jvxl.readers.SurfaceGenerator", ["java.io.BufferedReader", "$.InputStreamReader", "$.StringReader", "java.util.BitSet", "javax.vecmath.Point4f", "org.jmol.jvxl.data.JvxlCoder", "$.JvxlData", "$.MeshData", "$.VolumeData", "org.jmol.jvxl.readers.IsoPlaneReader", "$.IsoShapeReader", "$.JvxlXmlReader", "$.Parameters", "$.SurfaceReader", "$.VolumeDataReader", "org.jmol.util.ArrayUtil", "$.Logger", "$.Measure", "$.Parser", "$.SurfaceFileTyper", "$.TextFormat"], function () {
