...
Clazz.load (["org.jmol.jvxl.api.VertexDataServer", "javax.vecmath.Point3f"], "org.jmol.jvxl.readers.SurfaceReader", ["java.lang.Float", "java.util.BitSet", "org.jmol.g3d.Graphics3D", "org.jmol.jvxl.calc.MarchingCubes", "$.MarchingSquares", "org.jmol.jvxl.data.JvxlCoder", "$.MeshData", "org.jmol.util.BoxInfo", "$.ColorEncoder", "$.Escape", "$.Logger"], function () {
...
this.yzPlanes =  Clazz.newArray (2, 0);
this.yzPlanes[0] =  Clazz.newArray (this.yzCount, 0);
this.yzPlanes[1] =  Clazz.newArray (this.yzCount, 0);
});
...
if (this.meshDataServer == null) {
this.meshData.vertexColixes =  Clazz.newArray (this.meshData.vertexCount, 0);
} else {
this.meshDataServer.fillMeshData (this.meshData, 1, null);
...
this.jvxlData.minColorIndex = org.jmol.g3d.Graphics3D.getColixTranslucent (org.jmol.g3d.Graphics3D.getColix (this.params.isColorReversed ? this.params.colorPos : this.params.colorNeg), this.jvxlData.translucency != 0, this.jvxlData.translucency);
this.jvxlData.maxColorIndex = org.jmol.g3d.Graphics3D.getColixTranslucent (org.jmol.g3d.Graphics3D.getColix (this.params.isColorReversed ? this.params.colorNeg : this.params.colorPos), this.jvxlData.translucency != 0, this.jvxlData.translucency);
...
if (this.haveSurfaceAtoms && this.meshData.vertexSource == null) this.meshData.vertexSource =  Clazz.newArray (this.meshData.vertexCount, 0);
...
var colors = this.jvxlData.contourColixes =  Clazz.newArray (n, 0);
var values = this.jvxlData.contourValues;
if (values == null) values = this.jvxlData.contourValuesUsed;
if (this.jvxlData.contourValuesUsed == null) this.jvxlData.contourValuesUsed = (values == null ?  Clazz.newArray (n, 0) : values);
var dv = (valueBlue - valueRed) / (n + 1);
this.params.colorEncoder.setRange (this.params.valueMappedToRed, this.params.valueMappedToBlue, this.params.isColorReversed);
for (var i = 0; i < n; i++) {
var v = (values == null ? valueRed + (i + 1) * dv : values[i]);
this.jvxlData.contourValuesUsed[i] = v;
colors[i] = org.jmol.g3d.Graphics3D.getColixTranslucent (this.params.colorEncoder.getArgb (v));
}
this.jvxlData.contourColors = org.jmol.g3d.Graphics3D.getHexCodes (colors);
}}, $fz.isPrivate = true, $fz));
...
if (this.params.rangeSelected && !this.params.bsSelected.get (i)) continue ;var p = this.params.theProperty[i];
if (Float.isNaN (p)) continue ;if (p < min) min = p;
if (p > max) max = p;
}
