...
Clazz.load (["org.jmol.jvxl.readers.VolumeFileReader"], "org.jmol.jvxl.readers.JvxlXmlReader", ["java.lang.Float", "$.NullPointerException", "$.StringBuffer", "java.util.ArrayList", "$.BitSet", "$.Hashtable", "javax.vecmath.Point3f", "$.Point4f", "org.jmol.g3d.Graphics3D", "org.jmol.jvxl.data.JvxlCoder", "$.MeshData", "org.jmol.shapesurface.IsosurfaceMesh", "org.jmol.util.ArrayUtil", "$.ColorEncoder", "$.ColorUtil", "$.Escape", "$.Logger", "$.Parser", "$.XmlReader"], function () {
...
var color = org.jmol.util.XmlReader.getXmlAttrib (s, "color");
...
if (s.length > 0) {
this.jvxlData.contourColixes = this.params.contourColixes = org.jmol.g3d.Graphics3D.getColixArray (s);
this.jvxlData.contourColors = org.jmol.g3d.Graphics3D.getHexCodes (this.jvxlData.contourColixes);
org.jmol.util.Logger.info ("JVXL read: contourColixes " + org.jmol.g3d.Graphics3D.getHexCodes (this.jvxlData.contourColixes));
...
s = org.jmol.util.XmlReader.getXmlAttrib (data, "colorNegative");
...
this.jvxlDataIsColorMapped = ((this.params.colorRgb == -2147483648 || this.params.colorRgb == 2147483647) && (this.params.isBicolorMap || org.jmol.util.XmlReader.getXmlAttrib (data, "colorMapped").equals ("true")));
this.jvxlData.isJvxlPrecisionColor = org.jmol.util.XmlReader.getXmlAttrib (data, "precisionColor").equals ("true");
this.jvxlData.jvxlDataIsColorDensity = this.params.colorDensity = (this.params.colorRgb == -2147483648 && org.jmol.util.XmlReader.getXmlAttrib (data, "colorDensity").equals ("true"));
s = org.jmol.util.XmlReader.getXmlAttrib (data, "allowVolumeRender");
this.jvxlData.allowVolumeRender = this.params.allowVolumeRender = (s.length == 0 || s.equalsIgnoreCase ("true"));
s = org.jmol.util.XmlReader.getXmlAttrib (data, "plane");
if (s.indexOf ("{") >= 0) {
try {
...
s = org.jmol.util.XmlReader.getXmlAttrib (data, "rendering");
...
var insideOut = org.jmol.util.XmlReader.getXmlAttrib (data, "insideOut").equals ("true");
var dataMin = NaN;
var dataMax = NaN;
var red = NaN;
var blue = NaN;
...
try {
if (type.equals ("edge")) {
str = org.jmol.jvxl.data.JvxlCoder.jvxlUncompressString (org.jmol.util.XmlReader.getXmlAttrib (this.tempDataXml, "data"));
} else {
...
fraction = org.jmol.jvxl.data.JvxlCoder.jvxlFractionFromCharacter2 (this.jvxlColorDataRead.charAt (this.colorPtr).charCodeAt (0), this.jvxlColorDataRead.charAt ((this.colorPtr++) + this.valueCount).charCodeAt (0), this.colorFractionBase, this.colorFractionRange);
} else {
fraction = org.jmol.jvxl.data.JvxlCoder.jvxlFractionFromCharacter (this.jvxlColorDataRead.charAt (this.colorPtr++).charCodeAt (0), this.colorFractionBase, this.colorFractionRange, 0.5);
}break;
}
...
this.fractionPtr = 0;
}return org.jmol.jvxl.data.JvxlCoder.jvxlFractionFromCharacter (this.strFractionTemp.charAt (this.fractionPtr++).charCodeAt (0), base, range, fracOffset);
...
if (colixes == null || colixes.length < vertexCount) this.meshData.vertexColixes = colixes =  Clazz.newArray (vertexCount, 0);
var colixNeg = 0;
var colixPos = 0;
if (this.params.colorBySign) {
colixPos = org.jmol.g3d.Graphics3D.getColix (this.params.isColorReversed ? this.params.colorNeg : this.params.colorPos);
colixNeg = org.jmol.g3d.Graphics3D.getColix (this.params.isColorReversed ? this.params.colorPos : this.params.colorNeg);
...
continue ;}var colix = (!this.params.colorBySign ? this.params.colorEncoder.getColorIndex (value) : (this.params.isColorReversed ? value > 0 : value <= 0) ? colixNeg : colixPos);
colixes[i] = org.jmol.g3d.Graphics3D.getColixTranslucent (colix, true, this.jvxlData.translucency);
}
...
this.jvxlData.isJvxlPrecisionColor = org.jmol.util.XmlReader.getXmlAttrib (data, "encoding").endsWith ("2");
this.jvxlColorDataRead = org.jmol.jvxl.data.JvxlCoder.jvxlUncompressString (org.jmol.util.XmlReader.getXmlAttrib (data, "data"));
...
var p = (asArray ? null :  new javax.vecmath.Point3f ());
var fraction;
var s = org.jmol.jvxl.data.JvxlCoder.jvxlUncompressString (org.jmol.util.XmlReader.getXmlAttrib (data, "data"));
if (s.length == 0) s = this.xr.getXmlData ("jvxlVertexData", data, false, false);
for (var i = 0, pt = -1; i < vertexCount; i++) {
if (asArray) p = vertices[i] =  new javax.vecmath.Point3f ();
fraction = org.jmol.jvxl.data.JvxlCoder.jvxlFractionFromCharacter2 (s.charAt (++pt).charCodeAt (0), s.charAt (pt + ptCount).charCodeAt (0), colorFractionBase, colorFractionRange);
...
var triangles = null;
var triangle =  Clazz.newArray (3, 0);
var s = org.jmol.jvxl.data.JvxlCoder.jvxlUncompressString (org.jmol.util.XmlReader.getXmlAttrib (data, "data"));
if (s.length == 0) s = this.xr.getXmlData ("jvxlTriangleData", data, false, false);
var sEdge = org.jmol.jvxl.data.JvxlCoder.jvxlUncompressString (org.jmol.util.XmlReader.getXmlAttrib (edgeData, "data")).trim ();
var nextp =  Clazz.newArray (1, 0);
var nextc =  Clazz.newArray (1, 0);
var edgeMask = 7;
...
var colix = org.jmol.g3d.Graphics3D.getColix (org.jmol.util.ColorUtil.getArgbFromString (org.jmol.util.XmlReader.getXmlAttrib (s, "color")));
var color = org.jmol.g3d.Graphics3D.getArgb (colix);
...
jvxlData.contourColixes = this.params.contourColixes =  Clazz.newArray (n, 0);
jvxlData.contourValues = this.params.contoursDiscrete =  Clazz.newArray (n, 0);
for (var i = 0; i < n; i++) {
...
jvxlData.contourColors = org.jmol.g3d.Graphics3D.getHexCodes (jvxlData.contourColixes);
