...
function (thePlane, nSurfaceInts, surfaceData) {
...
}, "javax.vecmath.Point4f,~N,~S");
Clazz.defineMethod (c$, "setSurfaceInfoFromBitSet", 
function (bs, thePlane) {
var sb =  new StringBuffer ();
var nPoints = this.nPointsX * this.nPointsY * this.nPointsZ;
var nSurfaceInts = (thePlane != null ? 0 : org.jmol.jvxl.data.JvxlCoder.jvxlEncodeBitSet (bs, nPoints, sb));
this.setSurfaceInfo (thePlane, nSurfaceInts, sb.toString ());
