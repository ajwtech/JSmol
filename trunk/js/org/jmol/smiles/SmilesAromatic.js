...
if (bonds.length < 3) continue ;if (bonds.length > 3) return false;
}
...
if (!bsSelected.get (iAtom)) continue ;if (!bs.get (iAtom)) iSub = iAtom;
...
vMean.normalize ();
return true;
}, $fz.isPrivate = true, $fz), "javax.vecmath.Vector3f,javax.vecmath.Vector3f,~N");
