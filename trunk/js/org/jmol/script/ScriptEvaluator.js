...
this.setErrorMessage ("io error reading " + data[0] + ": " + data[1]);
return false;
}path = org.jmol.util.ZipUtil.getManifestScriptPath (data[1]);
...
if (amount == 0 && (type).charCodeAt (0) != ('\0').charCodeAt (0)) return ;
this.iToken = i0 + ((type).charCodeAt (0) == ('\0').charCodeAt (0) ? 2 : 3);
...
if (org.jmol.viewer.ActionManager.getPickingStyle (str) < 0) this.error (50, "SET PICKINGSTYLE " + type, str);
...
if (!type.equals ("PNGJ") && !type.equals ("ZIPALL")) this.error (22);
 ...
 else if (!isImage && !isExport && !org.jmol.util.Parser.isOneOf (type, "SCENE;JMOL;ZIP;ZIPALL;SPT;HISTORY;MO;ISOSURFACE;MESH;PMESH;VAR;FILE;FUNCTION;CD;CML;XYZ;XYZRN;XYZVIB;MENU;MOL;PDB;PGRP;PQR;QUAT;RAMA;SDF;V2000;V3000;INLINE")) this.error (54, "COORDS|FILE|FUNCTIONS|HISTORY|IMAGE|INLINE|ISOSURFACE|JMOL|MENU|MO|POINTGROUP|QUATERNION [w,x,y,z] [derivative]|RAMACHANDRAN|SPT|STATE|VAR x|ZIP|ZIPALL  CLIPBOARD", "CML|GIF|JPG|JPG64|JMOL|JVXL|MESH|MOL|PDB|PMESH|PNG|PNGJ|PNGT|PPM|PQR|SDF|V2000|V3000|SPT|XJVXL|XYZ|XYZRN|XYZVIB|ZIP" + driverList.toUpperCase ().$replace (';', '|'));
if (this.isSyntaxCheck) return "";
var bytes = null;
var doDefer = false;
if (data == null) {
...
if (this.isColorParam (i + 1)) {
slabColix = Short.$valueOf (org.jmol.util.Colix.getColixTranslucent (org.jmol.util.Colix.getColix (this.getArgbParam (i + 1)), slabTranslucency != 0, slabTranslucency));
i = this.iToken;
} else {
slabColix = Short.$valueOf (org.jmol.util.Colix.getColixTranslucent (1, slabTranslucency != 0, slabTranslucency));
...
sbCommand.append (" /*file*/" + org.jmol.util.Escape.escape (fname));
...
sbCommand.append (" =");
name = this.parameterAsString (++i);
sbCommand.append (" ").append (org.jmol.util.Escape.escape (name));
vxy.add (name);
...
sbCommand.append (" ").append (org.jmol.util.Escape.escape (pt3));
vxy.add (pt3);
var pt4;
ptX = ++this.iToken;
...
sbCommand.append (" /*file*/").append (org.jmol.util.Escape.escape (filename));
}if (fileIndex >= 0) sbCommand.append (" ").append (fileIndex);
}if (sType != null) sbCommand.append (" ").append (org.jmol.util.Escape.escape (sType));
surfaceObjectSeen = true;
break;
case 4106:
...
sbCommand.append (" lattice ").append (org.jmol.util.Escape.escape (pt));
if (isMapped) {
