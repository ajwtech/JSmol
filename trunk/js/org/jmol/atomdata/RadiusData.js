...
if (!Clazz.isClassDefined ("org.jmol.atomdata.RadiusData")) {
org.jmol.atomdata.RadiusData.$RadiusData$ ();
}
...
c$.$RadiusData$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareType (org.jmol.atomdata, "RadiusData", Enum);
