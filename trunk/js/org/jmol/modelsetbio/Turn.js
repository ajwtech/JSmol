...
function (apolymer, monomerIndex, monomerCount, id) {
Clazz.superConstructor (this, org.jmol.modelsetbio.Turn, [apolymer, org.jmol.constant.EnumStructure.TURN, monomerIndex, monomerCount, id]);
this.subtype = org.jmol.constant.EnumStructure.TURN;
}, "org.jmol.modelsetbio.AlphaPolymer,~N,~N,~N");
});
