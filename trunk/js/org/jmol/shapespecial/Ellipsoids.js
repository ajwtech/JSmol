...
this.ellipsoid.lengths =  Clazz.newArray (3, 0);
...
this.ellipsoid.colix = org.jmol.util.Colix.getColix (value);
return ;
...
this.ellipsoid.colix = org.jmol.util.Colix.getColixTranslucent (this.ellipsoid.colix, isTranslucent, this.translucentLevel);
return ;
...
($fz = function () {
if (this.colixset == null) {
this.colixset =  Clazz.newArray (3, 0);
this.paletteIDset =  Clazz.newArray (3, 0);
this.madset =  Clazz.newArray (3, 0);
...
var mTemp =  new javax.vecmath.Matrix3f ();
var v1 =  new javax.vecmath.Vector3f ();
ellipsoid.coef =  Clazz.newArray (10, 0);
...
if (this.madset == null || this.madset[ii] == null) continue ;org.jmol.viewer.StateManager.appendCmd (sb, "Ellipsoids set " + (ii + 1) + "\n");
