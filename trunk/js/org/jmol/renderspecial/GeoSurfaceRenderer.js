...
Clazz.load (["org.jmol.renderspecial.DotsRenderer", "javax.vecmath.Point3i"], "org.jmol.renderspecial.GeoSurfaceRenderer", ["org.jmol.util.Geodesic"], function () {
...
this.facePt1 =  new javax.vecmath.Point3i ();
this.facePt2 =  new javax.vecmath.Point3i ();
this.facePt3 =  new javax.vecmath.Point3i ();
});
...
if (this.iShowSolid && this.faceMap == null) this.faceMap =  Clazz.newArray (this.screenDotCount, 0);
this.render1 (gs);
});
...
p2 = faces[f++];
p3 = faces[f++];
if (p1 >= mapMax || p2 >= mapMax || p3 >= mapMax) continue ;if (!points.get (p1) || !points.get (p2) || !points.get (p3)) continue ;this.facePt1.set (coords[this.faceMap[p1]], coords[this.faceMap[p1] + 1], coords[this.faceMap[p1] + 2]);
